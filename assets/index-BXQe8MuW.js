 ...
 */var $0;function s1(){if($0)return hi;$0=1;var a=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function u(c,s,d){var g=null;if(d!==void 0&&(g=""+d),s.key!==void 0&&(g=""+s.key),"key"in s){d={};for(var b in s)b!=="key"&&(d[b]=s[b])}else d=s;return s=d.ref,{$$typeof:a,type:c,key:g,ref:s!==void 0?s:null,props:d}}return hi.Fragment=i,hi.jsx=u,hi.jsxs=u,hi}var _0;function f1(){return _0||(_0=1,As.exports=s1()),As.exports}var N=f1(),Cs={exports:{}},be={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var T0;function h1(){return T0||(T0=1,function(a){function i(U,K){var ee=U.length;U.push(K);e:for(;0<ee;){var F=ee-1>>>1,S=U[F];if(0<s(S,K))U[F]=K,U[ee]=S,ee=F;else break e}}function u(U){return U.length===0?null:U[0]}function c(U){if(U.length===0)return null;var K=U[0],ee=U.pop();if(ee!==K){U[0]=ee;e:for(var F=0,S=U.length,B=S>>>1;F<B;){var X=2*(F+1)-1,P=U[X],I=X+1,ue=U[I];if(0>s(P,ee))I<S&&0>s(ue,P)?(U[F]=ue,U[I]=ee,F=I):(U[F]=P,U[X]=ee,F=X);else if(I<S&&0>s(ue,ee))U[F]=ue,U[I]=ee,F=I;else break e}}return K}function s(U,K){var ee=U.sortIndex-K.sortIndex;return ee!==0?ee:U.id-K.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var g=Date,b=g.now();a.unstable_now=function(){return g.now()-b}}var v=[],m=[],y=1,E=null,x=3,w=!1,$=!1,j=!1,z=!1,M=typeof setTimeout=="function"?setTimeout:null,D=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function te(U){for(var K=u(m);K!==null;){if(K.callback===null)c(m);else if(K.startTime<=U)c(m),K.sortIndex=K.expirationTime,i(v,K);else break;K=u(m)}}function Z(U){if(j=!1,te(U),!$)if(u(v)!==null)$=!0,J||(J=!0,Oe());else{var K=u(m);K!==null&&Me(Z,K.startTime-U)}}var J=!1,ae=-1,se=5,ne=-1;function ge(){return z?!0:!(a.unstable_now()-ne<se)}function qe(){if(z=!1,J){var U=a.unstable_now();ne=U;var K=!0;try{e:{$=!1,j&&(j=!1,D(ae),ae=-1),w=!0;var ee=x;try{t:{for(te(U),E=u(v);E!==null&&!(E.expirationTime>U&&ge());){var F=E.callback;if(typeof F=="function"){E.callback=null,x=E.priorityLevel;var S=F(E.expirationTime<=U);if(U=a.unstable_now(),typeof S=="function"){E.callback=S,te(U),K=!0;break t}E===u(v)&&c(v),te(U)}else c(v);E=u(v)}if(E!==null)K=!0;else{var B=u(m);B!==null&&Me(Z,B.startTime-U),K=!1}}break e}finally{E=null,x=ee,w=!1}K=void 0}}finally{K?Oe():J=!1}}}var Oe;if(typeof L=="function")Oe=function(){L(qe)};else if(typeof MessageChannel<"u"){var Xe=new MessageChannel,lt=Xe.port2;Xe.port1.onmessage=qe,Oe=function(){lt.postMessage(null)}}else Oe=function(){M(qe,0)};function Me(U,K){ae=M(function(){U(a.unstable_now())},K)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(U){U.callback=null},a.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):se=0<U?Math.floor(1e3/U):5},a.unstable_getCurrentPriorityLevel=function(){return x},a.unstable_next=function(U){switch(x){case 1:case 2:case 3:var K=3;break;default:K=x}var ee=x;x=K;try{return U()}finally{x=ee}},a.unstable_requestPaint=function(){z=!0},a.unstable_runWithPriority=function(U,K){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var ee=x;x=U;try{return K()}finally{x=ee}},a.unstable_scheduleCallback=function(U,K,ee){var F=a.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?F+ee:F):ee=F,U){case 1:var S=-1;break;case 2:S=250;break;case 5:S=1073741823;break;case 4:S=1e4;break;default:S=5e3}return S=ee+S,U={id:y++,callback:K,priorityLevel:U,startTime:ee,expirationTime:S,sortIndex:-1},ee>F?(U.sortIndex=ee,i(m,U),u(v)===null&&U===u(m)&&(j?(D(ae),ae=-1):j=!0,Me(Z,ee-F))):(U.sortIndex=S,i(v,U),$||w||($=!0,J||(J=!0,Oe()))),U},a.unstable_shouldYield=ge,a.unstable_wrapCallback=function(U){var K=x;return function(){var ee=x;x=K;try{return U.apply(this,arguments)}finally{x=ee}}}}(Bs)),Bs}var M0;function m1(){return M0||(M0=1,Ds.exports=h1()),Ds.exports}var zs={exports:{}},Dt={};/**
 * @license React
...
`,xu=a=>{let i=a;return i=i.replace("box-shadow: ",""),i=i.replace(";",""),i},Ab=(a,i)=>{return(u=a,Object.keys(u)).some(c=>a[c]!==i[c]);var u};function og(a,i){const u={};return{observe(){u.rafId&&cancelAnimationFrame(u.rafId);const c=()=>{if(u.isObserving){const{scrollHeight:s,scrollLeft:d,scrollTop:g,scrollWidth:b}=a,{bottom:v,height:m,left:y,right:E,top:x,width:w,x:$,y:j}=a.getBoundingClientRect(),z={bottom:v,height:m,left:y,right:E,top:x,width:w,x:$||y,y:j||x,scrollHeight:s,scrollLeft:d,scrollTop:g,scrollWidth:b};Ab(z,u.rect||{})&&(u.rect=z,i(z)),u.rafId=requestAnimationFrame(c)}};u.rafId=requestAnimationFrame(c),u.isObserving=!0},unobserve(){u.rafId&&cancelAnimationFrame(u.rafId),u.isObserving&&(u.isObserving=!1)}}}var Cb=Bp();const Ob=Q.div`
  pointer-events: none;
  position: fixed;
  overflow: visible;
  z-index: var(--admiral-z-index-dropdown, ${({theme:a})=>a.zIndex.dropdown});
`,Cf=({targetElement:a,rootRef:i,fullContainerWidth:u,...c})=>{const s=h.useRef(null);return h.useEffect(()=>{const d=s.current;if(d&&a){const g=og(a,b=>{if(b){const{x:v,y:m,height:y,width:E}=b,{style:x}=d;x.top=`${m}px`,x.left=u?"0px":`${v}px`,x.height=`${y}px`,x.width=u?"100%":`${E}px`}});return g.observe(),()=>{g.unobserve()}}},[a,u]),Cb.createPortal(N.jsx(Ob,{ref:s,...c}),i?.current||document.body)};function Db(a,i){const u=h.useRef(null),c=h.useRef(a);return h.useEffect(()=>{c.current=a},[a]),h.useEffect(()=>(u.current=setInterval(()=>c.current(),i),()=>clearInterval(u.current||0)),[i]),u}function va(...a){return i=>{a.forEach(u=>{u&&(typeof u=="function"?u(i):u.current=i)})}}const Mi=h.createContext({}),Bb=({rootRef:a,...i})=>{const[u,c]=h.useState([]),[s,d]=h.useState(void 0),g=h.useCallback(E=>{d(E)},[]),b=h.useCallback(E=>{d(x=>x===E?void 0:x)},[]),v=h.useCallback(E=>{c(x=>{const w=x.indexOf(E);return w>-1?x.slice(0,w):x})},[]),m=h.useCallback(E=>{c(x=>[...x,E])},[]),y=h.useMemo(()=>({addDropdown:m,removeDropdown:v,dropdowns:u,rootRef:a,activateMenu:g,deactivateMenu:b,currentActiveMenu:s}),[m,v,u,a,g,b,s]);return N.jsx(Mi.Provider,{value:y,children:i.children})};function ug(a){const{dropdowns:i=[],addDropdown:u,removeDropdown:c,activateMenu:s,deactivateMenu:d,currentActiveMenu:g}=h.useContext(Mi),b=i.indexOf(a);return{addDropdown:u,removeDropdown:c,dropdowns:b>-1?i.slice(b+1,i.length):[],activateMenu:s,deactivateMenu:d,currentActiveMenu:g}}const zb=(a,i)=>!i.some(u=>u.current&&u.current.contains(a.target)),Rb=(a,i,u)=>{const c=a.bottom-a.top+8,s=i.top>=c,d=u-i.bottom>=c,g=i.top>=0&&i.bottom<=u,b=i.bottom<=0,v=i.top>=u,m=i.top<0&&0<i.bottom&&i.bottom<u,y=0<i.top&&i.top<u&&i.bottom>u;if(g){if(!s&&!d)return{upward:!1,translateY:u-i.bottom-c-16+"px"};if(s&&d)return{upward:!1,translateY:"0"};if(!s&&d)return{upward:!1,translateY:"0"};if(s&&!d)return{upward:!0,translateY:"0"}}else{if(b)return{upward:!1,translateY:0-i.bottom+8+"px"};if(v)return{upward:!0,translateY:u-i.top-8+"px"};if(m)return d?{upward:!1,translateY:"0"}:{upward:!1,translateY:0-i.bottom+8+"px"};if(y)return s?{upward:!0,translateY:"0"}:{upward:!0,translateY:""+(u-i.top-8)}}return{upward:!1,translateY:"0"}},Hb=(a,i,u)=>{const c=a.right-a.left,s=i.left>=0&&i.right<=u,d=i.right<=0,g=i.left>=u,b=i.left<0&&0<i.right&&i.right<u,v=i.right>u&&0<i.left&&i.left<u;if(s){const m=u-i.left>=c,y=i.right>=c,E=c>i.width;if(!y&&!m)return{align:"flex-end",translateX:u-i.right-16+"px"};if(y&&m)return{align:"flex-end",translateX:"0"};if(E&&!y&&m)return{align:"flex-start",translateX:"0"};if(E&&!m&&y)return{align:"flex-end",translateX:"0"}}else{if(d||b)return{align:"flex-start",translateX:0-i.left+16+"px"};if(g||v)return{align:"flex-end",translateX:u-i.right-16+"px"}}return{align:"",translateX:"0"}},jb=Q.div`
...
`,Ub=Q(Cf)`
  ...
  flex-wrap: nowrap;
`,kb=()=>null,Of=h.forwardRef(({targetElement:a,onClickOutside:i=kb,className:u="",alignSelf:c,dropContainerCssMixin:s,...d},g)=>{const b=h.useRef(null),[v,m]=h.useState(!1),{rootRef:y}=h.useContext(Mi);h.useLayoutEffect(()=>{b.current!==document.activeElement&&b?.current?.focus()},[]);const E=h.useCallback(()=>{const $=b.current;if($&&a){const j=$.getBoundingClientRect(),z=a.getBoundingClientRect(),M=globalThis.innerHeight,D=globalThis.innerWidth,{upward:L,translateY:te}=Rb(j,z,M);if(v!==L&&m(L),c&&c!=="auto")$.style.transform=`translateY(${te})`;else{const{align:Z,translateX:J}=Hb(j,z,D);$.style.transform=`translate(${J}, ${te})`,$.style.alignSelf=Z}}},[v,a]);Db(E,100),h.useEffect(()=>{b.current&&(b.current.style.opacity="1")},[]);const[x,w]=h.useState(!1);return h.useEffect(()=>{function $(){w(!0)}return document.addEventListener("mousedown",$,!0),document.addEventListener("touchstart",$,!0),()=>{document.removeEventListener("mousedown",$,!0),document.removeEventListener("touchstart",$,!0)}},[]),h.useEffect(()=>{function $(j){i(j)}if(x)return document.addEventListener("mouseup",$),document.addEventListener("touchend",$),()=>{document.removeEventListener("mouseup",$),document.removeEventListener("touchend",$)}},[x]),N.jsx(N.Fragment,{children:N.jsxs(Ub,{targetElement:a,$reverse:v,rootRef:y,onMouseDown:()=>w(!1),children:[N.jsx(Lb,{}),N.jsx(jb,{ref:va(g,b),...d,className:u+" dropdown-container",$alignSelf:c,$dropContainerCssMixin:s})]})})});Of.displayName="DropdownContainer";const qb=Q(Of)`
...
`;qb.displayName="StyledDropdownContainer";function Yb(...a){return i=>a.forEach(u=>function(c,s){typeof c=="function"?c(s):c!=null&&(c.current=s)}(u,i))}function tf(...a){return h.useCallback(Yb(...a),a)}function Df(a){return h.forwardRef(a)}const Bf=Y`
  overflow: scroll;
...
`,Ib=Df(({children:a,verticalScrollProps:i,horizontalScrollProps:u,minThumbSize:c=20,contentBlockProps:s={},...d},g)=>{const b=h.useMemo(()=>s.id?s.id:`scroll-aria-${Math.random().toString(36).substring(2,12)}`,[s.id]),[v,m]=h.useState(null),y=tf(s.ref,E=>m(E));return N.jsxs(Vb,{ref:g,...d,children:[N.jsx(Pb,{...s,id:b,ref:y,children:a}),N.jsx(cg,{contentNode:v,verticalScrollProps:i,horizontalScrollProps:u,minThumbSize:c})]})}),cg=({verticalScrollProps:a={},horizontalScrollProps:i={},contentNode:u,minThumbSize:c=20})=>{const s=h.useMemo(()=>u?.id?u?.id:`scroll-aria-${Math.random().toString(36).substring(2,12)}`,[u?.id]),[d,g]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState(null),[E,x]=h.useState(null),[w,$]=h.useState(null),[j,z]=h.useState(null),[M,D]=h.useState(!1),[L,te]=h.useState(!1),[Z,J]=h.useState(0),[ae,se]=h.useState(0),[ne,ge]=h.useState(0),[qe,Oe]=h.useState(0),[Xe,lt]=h.useState(0),[Me,U]=h.useState(0),K=tf(a.ref,F=>g(F)),ee=tf(i.ref,F=>y(F));return h.useLayoutEffect(()=>{if(u&&w&&j&&d&&m&&b&&E){const{observe:F,unobserve:S}=og(u,B=>{if(B){const X=function($t){const{clientHeight:Qe,scrollHeight:Lt}=$t;return Lt-Qe>=1}(u),P=function($t){const{clientWidth:Qe,scrollWidth:Lt}=$t;return Lt-Qe>=1}(u),I=Math.min(Math.max(0,B.scrollTop),B.scrollHeight-B.height),ue=Math.min(Math.max(0,B.scrollLeft),B.scrollWidth-B.width);u.style.setProperty("--vertical-content-scroll",`${I}px`),u.style.setProperty("--horizontal-content-scroll",`${ue}px`),d.style.setProperty("display",X?null:"none"),d.style.setProperty("bottom",P?"10px":null),m.style.setProperty("display",P?null:"none"),m.style.setProperty("right",X?"10px":null);const re=function($t,Qe){const{clientHeight:Lt,scrollHeight:Rt}=$t,{clientHeight:mt}=Qe;return Math.max(Math.round(Lt*mt/Rt),c)}(u,b),Ve=function($t,Qe){const{clientWidth:Lt,scrollWidth:Rt}=$t,{clientWidth:mt}=Qe;return Math.max(Math.round(Lt*mt/Rt),c)}(u,E);w.style.setProperty("--vertical-thumb-height",`${re}px`),j.style.setProperty("--horizontal-thumb-width",`${Ve}px`);const{scrollTop:ve,scrollLeft:Je,scrollHeight:Mt,scrollWidth:Pe}=u,{clientHeight:Be}=b,{clientWidth:zt}=E,Ma=Math.round(Math.min(ve/Mt*Be,Be-re)),Va=Math.round(Math.min(Je/Pe*zt,zt-Ve));w.style.top=`${Ma}px`,j.style.left=`${Va}px`}});return F(),S}},[u,w,j,d,m,b,E]),h.useEffect(()=>{function F(B){B.preventDefault(),B.stopPropagation(),M&&D(!1),L&&te(!1)}function S(B){if(u){if(B.preventDefault(),B.stopPropagation(),M){const{scrollHeight:X,clientHeight:P}=u,I=(B.clientY-Z)*(X/P),ue=Math.round(Math.min(ne+I,X-P));u.scrollTop=ue}if(L){const{scrollWidth:X,clientWidth:P}=u,I=(B.clientX-ae)*(X/P),ue=Math.round(Math.min(qe+I,X-P));u.scrollLeft=ue}}}if(M||L)return document.addEventListener("mousemove",S),document.addEventListener("mouseup",F),()=>{document.removeEventListener("mousemove",S),document.removeEventListener("mouseup",F)}},[u,M,L,ne,qe,Z,ae]),h.useEffect(()=>{if(u){const{scrollHeight:F,clientHeight:S}=u,B=Math.round(Xe*F-S/2);u.scrollTo({top:B,behavior:"smooth"})}},[Xe]),h.useEffect(()=>{if(u){const{scrollWidth:F,clientWidth:S}=u,B=Math.round(Me*F-S/2);u.scrollTo({left:B,behavior:"smooth"})}},[Me]),h.useEffect(()=>{document.body.style.setProperty("cursor",M||L?"grabbing":null)},[M,L]),N.jsxs(N.Fragment,{children:[N.jsxs(Gb,{...a,ref:K,role:"scrollbar","aria-controls":s,children:[N.jsx(Wb,{onClick:function(F){if(F.preventDefault(),F.stopPropagation(),u){const{clientHeight:S}=u,{top:B}=u.getBoundingClientRect();lt((F.clientY-B)/S)}}}),N.jsx(Qb,{ref:F=>v(F),children:N.jsx(Jb,{ref:$,onMouseDown:function(F){F.preventDefault(),F.stopPropagation(),J(F.clientY),u&&ge(u.scrollTop),D(!0)},style:{cursor:M?"grabbing":"grab"}})})]}),N.jsxs(Xb,{...i,ref:ee,role:"scrollbar","aria-controls":s,children:[N.jsx(Fb,{onClick:function(F){if(F.preventDefault(),F.stopPropagation(),u){const{clientWidth:S}=u,{left:B}=u.getBoundingClientRect();U((F.clientX-B)/S)}}}),N.jsx(Zb,{ref:F=>x(F),children:N.jsx(Kb,{ref:z,onMouseDown:function(F){F.preventDefault(),F.stopPropagation(),se(F.clientX),u&&Oe(u.scrollLeft),te(!0)},style:{cursor:L?"grabbing":"grab"}})})]})]})},ex=Y`
...
`;var K0;function af(){return af=Object.assign?Object.assign.bind():function(a){for(var i=1;i<arguments.length;i++){var u=arguments[i];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},af.apply(null,arguments)}var nx=function(a){return h.createElement("svg",af({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),K0||(K0=h.createElement("path",{fill:"#74767B",fillRule:"evenodd",d:"M9.99 16.21c-.18 0-.35-.07-.48-.21a.66.66 0 0 1 .04-.92l3.49-3.15-3.48-3.02a.65.65 0 0 1-.04-.92c.24-.26.65-.28.92-.04l3.97 3.46c.31.28.31.76 0 1.04l-3.98 3.59c-.13.12-.28.17-.44.17"})))};const rx=Q(nx)`
  transition: all 0.3s;
  flex-shrink: 0;
  width: 24px;
  height: 24px;
...
`,ix=a=>{a.preventDefault(),a.stopPropagation()},zf=h.forwardRef(({children:a,expandIcon:i=N.jsx(rx,{}),hasSubmenu:u,onHover:c,disabled:s,readOnly:d,hovered:g,dimension:b="l",selected:v=!1,preselected:m=!1,selfRef:y,onMouseDown:E,onLeave:x,containerRef:w,...$},j)=>{const z=s?ix:E,M=y?va(j,y):j;return N.jsxs(ox,{ref:M,$dimension:b,$preselected:m,$selected:v,$hovered:g,"data-preselected":m,"data-hovered":g,"data-disabled":s,"data-readonly":d,"data-dimension":b,onMouseEnter:D=>{c?.(D),$.onMouseEnter?.(D)},onMouseLeave:D=>{x?.(D),$.onMouseLeave?.(D)},onMouseMove:D=>{c?.(D),$.onMouseMove?.(D)},onMouseDown:z,...$,children:[h.Children.toArray(a).map((D,L)=>typeof D=="string"?N.jsx(ux,{children:D},D+L):D),u&&i]})});zf.displayName="MenuItem";const ox=Q.div`
  display: flex;
  align-items: center;
  user-select: none;
  position: relative;
...
`;function Rf(a){const i=h.useRef();return h.useEffect(()=>{i.current=a}),i.current}const W0=Q.div`
  display: flex;
  flex: 0 0 auto;
`,cx=({scrollContainerRef:a,itemHeight:i,rowCount:u=6,aheadItemsCount:c=3,model:s,activeId:d,selected:g,onRenderItem:b})=>{const[v,m]=h.useState(0),[y,E]=h.useState({startIndex:0,endIndex:u,topPadding:"",bottomPadding:"",needAddListener:!1}),x=Rf({activeId:d}),w=h.useCallback(z=>{requestAnimationFrame(()=>{z.target&&m(z.target.scrollTop)})},[a]);h.useEffect(()=>{const z=a.current;return m(z?.scrollTop||0),z?.addEventListener("scroll",w),()=>z?.removeEventListener("scroll",w)},[w]),h.useEffect(()=>{y.needAddListener&&(setTimeout(()=>a?.current?.addEventListener("scroll",w)),E({...y,needAddListener:!1}))},[y,a]);const $=h.useCallback(z=>{const M=s.length,D=Math.max(0,z);let L=u+2*c;return L=Math.min(M-D,L),{startIndex:D,endIndex:D+L,topPadding:D*i+"px",bottomPadding:(M-D-L)*i+"px"}},[i,c,s,u]);h.useEffect(()=>{const z=Math.floor(v/i-c),M={...$(z),needAddListener:!1};E(M)},[v,$]),h.useEffect(()=>{if(!d||!x||x.activeId===d)return;const z=s.findIndex(M=>M.id===d);z!==-1&&(z<y.startIndex||z>y.endIndex)&&(a?.current?.removeEventListener("scroll",w),E({...$(z),needAddListener:!0}))},[d,y,$,a]);const j=h.useMemo(()=>[...s].slice(y.startIndex,y.endIndex).map((z,M)=>b?.(z,M)),[s,d,g,y]);return N.jsxs(N.Fragment,{children:[N.jsx(W0,{style:{minHeight:y.topPadding}}),j,N.jsx(W0,{style:{minHeight:y.bottomPadding}})]})},sg=(a,i)=>{const u=h.useCallback(c=>{a.every(s=>s.current&&!s.current.contains(c.target))&&i(c)},[i,a]);h.useEffect(()=>(document.addEventListener("mousedown",u,!0),document.addEventListener("touchstart",u),()=>{document.removeEventListener("mousedown",u,!0),document.removeEventListener("touchstart",u)}),[u])},sx=(a,i)=>{let u,c=!1,s=!1;return[(...d)=>{if(s||c)return;const g=a(...d);return c=!0,u=setTimeout(()=>{c=!1},i),g},()=>{s=!0,clearTimeout(u)}]};function fx(a,i,u){const c=a.getBoundingClientRect(),s=i.getBoundingClientRect(),d=document.documentElement.clientWidth-c.right>s.width,g=c.left>s.width,b=u==="right"?!d&&g?"left":"right":!g&&d?"right":"left";return document.documentElement.clientHeight-c.top>s.height-1?{position:`${b}Bottom`}:{position:b,bottomOffset:8-(document.documentElement.clientHeight-c.top-s.height)}}const fg=(a,i)=>{for(let u=0;u<a.length;u++){const c=a[u];if(c.id===i)return c;if(c.subItems&&c.subItems.length>0){const s=fg(c.subItems,i);if(s)return s}}},dg=(a,i)=>!!a.subItems&&a.subItems.some(u=>i.includes(u.id)||dg(u,i)),J0=a=>Array.isArray(a)?[...a]:[a],dx=Q.div`
...
`,gx=Q.div`
  ...
  overflow: hidden;
  box-sizing: border-box;
`,hg=({targetElement:a,children:i,onClickOutside:u,defaultRenderDirection:c="right",...s})=>{const{rootRef:d}=h.useContext(Mi),g=h.useRef(null),[b,v]=h.useState(null),[m,y]=h.useState("row");h.useLayoutEffect(()=>{const[$,j]=sx(()=>{v({})},100);return addEventListener("resize",$),addEventListener("scroll",$),()=>{removeEventListener("resize",$),removeEventListener("scroll",$),j()}});const{addDropdown:E,removeDropdown:x,dropdowns:w}=ug(g);return h.useLayoutEffect(()=>(E?.(g),()=>{x?.(g)}),[]),sg([g],$=>{a&&!a.contains($.target)&&zb($,w)&&u?.($)}),h.useLayoutEffect(()=>{const $=g.current;if(a&&$){const{position:j,bottomOffset:z=0}=fx(a,$,c);switch(j){case"right":y("row"),$.style.bottom=`${z}px`;break;case"left":y("row-reverse"),$.style.bottom=`${z}px`;break;case"rightBottom":default:y("row"),$.style.bottom="8px";break;case"leftBottom":y("row-reverse"),$.style.bottom="8px"}}},[a,b]),a&&N.jsx(dx,{children:N.jsxs(hx,{targetElement:a,rootRef:d,$flexDirection:m,fullContainerWidth:!1,children:[N.jsx(mx,{}),N.jsx(px,{ref:g,...s,children:N.jsx(gx,{children:i})})]})})};hg.displayName="SubMenu";const mg=a=>{switch(a){case"l":default:return 48;case"m":return 40;case"s":return 32}},vx=Y`
  max-height: ${({$dimension:a,$rowCount:i})=>{return`min(calc(100vh - 16px), ${u=i,c=a,mg(c)*u+16}px)`;var u,c}};
`,yx=Q.div`
  overflow: hidden;
  position: relative;
...
`,Hf=h.forwardRef(({model:a,defaultSelected:i,selected:u,preselected:c,active:s,onPreselectItem:d,onSelectItem:g,onDeselectItem:b,onActivateItem:v,renderTopPanel:m,renderBottomPanel:y,dimension:E="l",multiSelection:x=!1,disableSelectedOptionHighlight:w=!1,onForwardCycleApprove:$,onBackwardCycleApprove:j,containerRef:z,virtualScroll:M,rowCount:D=6,parentMenuRef:L,onCloseQuery:te,defaultIsActive:Z=!0,subMenuRenderDirection:J,preventFocusSteal:ae,maxHeight:se,preselectedModeActive:ne=!1,onMenuKeyDown:ge,disableSelectionOnSpace:qe,disableSelectionOnEnter:Oe,...Xe},lt)=>{const Me=ie=>{const pe=ie?a.findIndex(Ie=>Ie.id===ie):-1;let me=pe<a.length-1?pe+1:0,je=!1;for(;(a[me].disabled||a[me].readOnly)&&!je;)me=me<a.length-1?me+1:0,je=pe===-1?me===0:me===pe;return me=!(pe>-1&&me<pe)||!$||$()?me:pe,a[me].disabled||a[me].readOnly?void 0:a[me].id},U=a.length>0?Me():void 0,[K,ee]=h.useState(i?J0(i):[]),[F,S]=h.useState(U),[B,X]=h.useState(U),P=h.useRef(null),I=h.useRef(null),[ue,re]=h.useState(null),[Ve,ve]=h.useState(!1),Je=h.useRef();h.useEffect(()=>{S(U)},[a]);const Mt=w?[]:u===void 0?K:J0(u),Pe=s===void 0?F:s,Be=ne?c===void 0?B:c:void 0,zt=h.useRef(null),Ma=h.useRef(null),Va=!!m,$t=!!y,Qe=ie=>{Pe!==ie&&S(ie),v?.(ie)},Lt=ie=>{Be!==ie&&X(ie),d?.(ie)},Rt=ie=>{const pe=fg(a,ie);if(pe&&!pe.disabled&&!pe.readOnly){const me=K.findIndex(je=>je===ie);x?me>-1?(ee(K.splice(me,1)),b?.(ie)):(ee([...K,ie]),g?.(ie)):(me===-1&&ee([ie]),g?.(ie))}},{currentActiveMenu:mt,activateMenu:ea,deactivateMenu:kl}=ug(P);h.useEffect(()=>{function ie(pe){if(mt?.current===P.current)switch(G.getCode(pe)){case G[" "]:if(qe)break;ne&&Be?Rt(Be):Pe&&Rt(Pe),pe.preventDefault();break;case G.Enter:if(Oe)break;ne&&Be?Rt(Be):Pe&&Rt(Pe),pe.preventDefault();break;case G.ArrowDown:{const me=Me(ne&&Be||Pe);ne?Lt(me):Qe(me),pe.preventDefault();break}case G.ArrowUp:{const me=(je=>{const Ie=je?a.findIndex(we=>we.id===je):-1;let ze=Ie>0?Ie-1:a.length-1,Vt=!1;for(;(a[ze].disabled||a[ze].readOnly)&&!Vt;)ze=ze>0?ze-1:a.length-1,Vt=Ie===-1?ze===0:ze===Ie;return ze=Ie>-1&&ze>Ie&&j&&!j()?Ie:ze,a[ze].disabled||a[ze].readOnly?void 0:a[ze].id})(ne&&Be||Pe);ne?Lt(me):Qe(me),pe.preventDefault();break}case G.ArrowRight:{const me=ne&&Be||Pe,je=a.find(Ie=>Ie.id===me);!je||je.disabled||je.readOnly||!je.subItems||Ve||ve(!0),I&&I.current&&ea?.(I);break}case G.ArrowLeft:L&&L.current&&te?.();break;default:ge?.(pe)}}return document.addEventListener("keydown",ie),()=>{document.removeEventListener("keydown",ie)}},[s,Pe,F,mt,Be,qe,Oe]),h.useEffect(()=>(Z&&ea?.(P),()=>{Z&&mt===P&&kl?.(P)}),[Z]);const vn=()=>{ve(!1),ea?.(P)},Fe=(ie,pe)=>{const{id:me,subItems:je,render:Ie,...ze}=ie,Vt=!!je&&je.length>0,we=Pe===me,Pt=Mt.includes(me)||dg(ie,Mt),Gt={hovered:we,preselected:Be!==void 0?Be===me:void 0,selected:Pt,onLeave:ta=>{const aa=ta.relatedTarget;aa&&Object.hasOwn(aa,"nodeName")&&!I.current?.contains(aa)&&!Ma.current?.contains(aa)&&ve(!1)},onHover:ta=>{Qe(me),ve(Vt),re(ta.currentTarget)},onMouseDown:ae?ta=>ta.preventDefault():void 0,onClick:()=>Rt(me),hasSubmenu:Vt,disabled:ze.disabled,...ze};return typeof Ie=="function"?Ie({containerRef:z,...Gt}):N.jsx(zf,{...Gt,children:Ie},`${ie.id}-${pe}`)},ql=h.useRef(),Aa=h.useRef(),yt=h.useRef(),Ke=h.useRef();h.useLayoutEffect(()=>{setTimeout(()=>{let ie;if(s&&ql.current!==s||Aa.current!==F?ie=zt.current?.querySelector('[data-hovered="true"]'):(c&&yt.current!==c||Ke.current!==B)&&(ie=zt.current?.querySelector('[data-preselected="true"]')),ie){const pe=Date.now(),me=Je.current;ie?.scrollIntoView({behavior:!me||pe-me<150?"auto":"smooth",inline:"center",block:"nearest"}),Je.current=pe,ql.current=s,Aa.current=F,yt.current=c,Ke.current=B}},0)},[s,F,c,B,a]);const ut=ig(Xe);return h.useEffect(()=>{if(!ue||!zt.current)return;const ie={root:zt.current,rootMargin:"0px",threshold:.5},pe=new IntersectionObserver(me=>{me.forEach(je=>{ve(!(je.intersectionRatio<ie.threshold))})},ie);return pe.observe(ue),()=>pe.disconnect()},[ue]),N.jsxs(yx,{ref:va(P,lt),$dimension:E,$hasTopPanel:Va,$hasBottomPanel:$t,onMouseEnter:ie=>{mt!==P&&ea?.(P),Xe.onMouseEnter?.(ie)},onMouseLeave:ie=>{Qe(void 0),Xe.onMouseLeave?.(ie)},onFocus:ie=>{mt!==P&&ea?.(P),Xe.onFocus?.(ie)},onBlur:ie=>{mt===P&&kl?.(P),Xe.onBlur?.(ie)},...Xe,children:[Va&&m({dimension:E}),N.jsx(bx,{$dimension:E,$rowCount:D,$hasTopPanel:Va,$hasBottomPanel:$t,$maxHeight:se,...ut,verticalScrollProps:{ref:Ma},contentBlockProps:{ref:zt},children:M?(()=>{if(!M)return null;const ie=M.itemHeight==="auto"?mg(E):M.itemHeight;return N.jsx(cx,{scrollContainerRef:zt,itemHeight:ie,model:a,rowCount:D,activeId:Pe,selected:Mt,onRenderItem:Fe})})():a.map((ie,pe)=>Fe({dimension:E,...ie},pe))}),Ve&&ue&&N.jsx(hg,{targetElement:ue,defaultRenderDirection:J,onClickOutside:L?void 0:()=>{ve(!1)},children:(()=>{const ie=a.find(pe=>pe.id===Pe);return ie&&ie.subItems&&ie.subItems.length>0&&N.jsx(Hf,{ref:I,dimension:E,parentMenuRef:P,model:ie.subItems,subMenuRenderDirection:J,onCloseQuery:vn,selected:Mt,onSelectItem:pe=>Rt(pe),virtualScroll:M,preventFocusSteal:!0})})()}),$t&&y({dimension:E})]})});Hf.displayName="Menu";var I0;function lf(){return lf=Object.assign?Object.assign.bind():function(a){for(var i=1;i<arguments.length;i++){var u=arguments[i];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},lf.apply(null,arguments)}var Su=function(a){return h.createElement("svg",lf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),I0||(I0=h.createElement("path",{fill:"#74767B",d:"M6.4 5.49a.63.63 0 0 0-.91 0c-.26.25-.26.66 0 .91l5.59 5.59-5.49 5.5c-.26.25-.26.66 0 .91.25.26.66.26.91 0l5.5-5.49 5.49 5.49c.25.26.66.26.91 0 .26-.25.26-.66 0-.91l-5.49-5.5L18.5 6.4c.26-.25.26-.66 0-.91a.63.63 0 0 0-.91 0L12 11.08z"})))};function $i(a){switch(a){case"lSmall":case"lBig":default:return 24;case"mSmall":case"mBig":return 20;case"s":return 16}}function pg(a){switch(a){case"lBig":case"mBig":default:return 6;case"lSmall":case"mSmall":case"s":return 4}}function ep(a){return $i(a)+2*pg(a)}const xx=Y`
  & *[fill^='#'] {
...
`,jf=Y`
  animation: ${a=>Mx(a)} 2s ease infinite;
`,Ax=()=>{let a=0;const i=document.createElement("div");return i.innerHTML=`Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diem 
    nonummy nibh euismod tincidunt ut lacreet dolore magna aliguam erat volutpat. 
    Ut wisis enim ad minim veniam, quis nostrud exerci tution ullamcorper suscipit 
    lobortis nisl ut aliquip ex ea commodo consequat.`,i.style.overflow="scroll",i.style.fontSize="14px",i.style.height="50px",i.style.maxHeight="50px",i.style.width="100px",i.style.position="absolute",i.style.top="-100000px",i.style.left="-100000px",document.body.appendChild(i),a=i.offsetWidth-i.clientWidth,document.body.removeChild(i),a||16},Cx=Q.div`
  box-sizing: border-box;
  opacity: 0;
  transition-delay: 200ms;
  transition-property: opacity;
...
`,Ux=Q.div`
  ...
  ${Lx}
  user-select: none;
`,Lf=h.forwardRef(({children:a,dimension:i="m",appearance:u="light",locale:c,...s},d)=>{const g=Af()||bu,b=c?.amountAriaLabel||g.locales[g.currentLocale].badge.amountAriaLabel;return N.jsx(Ux,{ref:d,$dimension:i,$appearance:u,"aria-label":`${b} ${a}`,...s,children:a})});Lf.displayName="Badge";Q(Lf)`
...
`,fp=Q.div`
  display: inline-block;
  width: 2px;
`,fu=h.forwardRef(({appearance:a="primary",dimension:i="xl",type:u="button",loading:c=!1,skeleton:s=!1,iconStart:d,iconEnd:g,icon:b,iconPlace:v="left",children:m,buttonCssMixin:y,displayAsDisabled:E,displayAsSquare:x,...w},$)=>{const j=!!d||!!b&&v==="left",z=!!g||!!b&&v==="right",M=(x||j?0:2)+(x||z?0:2);return N.jsxs(Zx,{ref:$,$appearance:a,$dimension:i,type:u,$loading:c,$skeleton:s,$buttonCssMixin:y,$displayAsSquare:x,$displayAsDisabled:E,...w,children:[c&&N.jsx(Qx,{children:N.jsx(gg,{$inverse:a!=="secondary"&&a!=="tertiary"&&a!=="ghost"})}),!x&&!j&&N.jsx(fp,{}),N.jsxs(vg,{$addPadding:M,children:[j?N.jsx(cr,{children:d||b}):null,h.Children.toArray(m).map((D,L)=>typeof D=="string"?N.jsx("div",{children:D},D+L):D),z?N.jsx(cr,{children:g||b}):null]}),!x&&!z&&N.jsx(fp,{})]})}),Zx=Q.button.attrs(a=>({"data-dimension":a.$dimension,"data-appearance":[a.$appearance,a.$displayAsDisabled?"disabled":void 0].filter(i=>i!==void 0).join(" ")}))`
  position: relative;
  box-sizing: border-box;
  display: inline-block;
  white-space: nowrap;
...
`;fu.displayName="Button";var dp;function rf(){return rf=Object.assign?Object.assign.bind():function(a){for(var i=1;i<arguments.length;i++){var u=arguments[i];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},rf.apply(null,arguments)}var Fx=function(a){return h.createElement("svg",rf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 16 16"},a),dp||(dp=h.createElement("path",{fill:"#fff",d:"M13.471 5.805a.667.667 0 1 0-.942-.943L7 10.39 4.138 7.53a.667.667 0 0 0-.943.942l3.334 3.334c.26.26.682.26.942 0z"})))},hp;function of(){return of=Object.assign?Object.assign.bind():function(a){for(var i=1;i<arguments.length;i++){var u=arguments[i];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},of.apply(null,arguments)}var Kx=function(a){return h.createElement("svg",of({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"-5 -9 20 20"},a),hp||(hp=h.createElement("rect",{width:10,height:2,fill:"#fff",rx:1})))};const Wx=Y`
...
`,Sg=h.forwardRef(({className:a,dimension:i="m",disabled:u,readOnly:c,hovered:s,indeterminate:d,error:g,...b},v)=>N.jsxs(tS,{$dimension:i,$disabled:u,$readOnly:c,className:a,children:[N.jsx(rS,{ref:v,disabled:u,readOnly:c,...b,type:"checkbox",$indeterminate:d,onKeyDown:m=>{c&&G.getCode(m)===G[" "]&&m.preventDefault(),b.onKeyDown?.(m)},"data-hovered":s,$hovered:s}),N.jsx(fn,{$error:g,children:N.jsx(d?eS:Ix,{"aria-hidden":"true",focusable:"false"})})]}));Sg.displayName="Checkbox";function Eg(){return(performance.now().toString(36)+Math.random().toString(36)).replace(/\./g,"")}const iS=Y`
...
`,Uf=({dimension:a="m",inverse:i=!1,svgMixin:u,...c})=>N.jsx(dS,{$dimension:a,$svgMixin:u,role:"alert","aria-live":"assertive",...c,children:N.jsx(gg,{$inverse:i})});Uf.displayName="Spinner";const mn=a=>!!a&&(a.offsetHeight<a.scrollHeight||a.offsetWidth<a.scrollWidth),df=a=>{switch(a.$dimension){case"xl":default:return 24;case"s":return 20}},Ni=a=>{switch(a.$dimension){case"xl":default:return 16;case"s":return 12}},hS=Y`
...
`,yS=Y`
  &:focus-within:not(:disabled) > ${lr} {
    ${a=>a.disabled||a.readOnly?"border-color: transparent":a.$isLoading?"":vS}
  }

  &:hover:not(:focus-within) > ${lr} {
    ${a=>a.$isLoading?"":a.disabled||a.readOnly?"transparent":gS};
  }
`,bS=Y`
  ::-ms-clear,
  ::-ms-reveal {
...
`;function _S(a){return a||{}}const wg=h.forwardRef(({dimension:a="m",type:i,displayClearIcon:u,isLoading:c,status:s,handleInput:d=_S,containerRef:g,icons:b,iconsBefore:v,iconsAfter:m,children:y,className:E,style:x,placeholder:w,skeleton:$=!1,showTooltip:j=!0,disableCopying:z,...M},D)=>{const L=h.useRef(null),te=g||h.useRef(null),Z=h.Children.toArray(m||b),J=h.Children.toArray(v),[ae,se]=h.useState(!1),[ne,ge]=h.useState(!1),[qe,Oe]=h.useState(M.defaultValue??void 0),Xe=M.value??qe;h.useEffect(()=>{mn(L.current)?se(!0):se(!1)},[ne,se]),h.useLayoutEffect(()=>{function ee(){document.activeElement!==L.current&&ge(!0)}function F(){ge(!1)}const S=te.current;if(S)return S.addEventListener("mouseenter",ee),S.addEventListener("mouseleave",F),S.addEventListener("mousedown",F),()=>{S.removeEventListener("mouseenter",ee),S.removeEventListener("mouseleave",F),S.removeEventListener("mousedown",F)}},[ge]);const[lt,Me]=h.useState(!1);if(!M.readOnly&&i==="password"){const ee=lt?cS:uS;Z.push(N.jsx(_i,{icon:ee,onClick:()=>{Me(!lt)},"aria-hidden":!0},"eye-icon"))}!M.readOnly&&u&&Xe&&Z.unshift(N.jsx(_i,{icon:Su,onMouseDown:ee=>{ee.preventDefault()},onClick:()=>{L.current&&pa(L.current,{value:""})},"aria-hidden":!0},"clear-icon")),c&&Z.unshift(N.jsx(Uf,{dimension:a==="s"?"ms":"m"},"loading-icon"));const U=J.length,K=Z.length;return h.useLayoutEffect(()=>{const ee=d(null);function F(S){const{value:B,selectionStart:X,selectionEnd:P}=this,I=d({value:B,selectionStart:X,selectionEnd:P},S);w&&!cf(ee,I)?pa(this,{...I,value:""}):pa(this,I)}if(i!=="date"&&L.current){const S=L.current;S.addEventListener("input",F);const{value:B,selectionStart:X,selectionEnd:P}=S,I=d({value:B,selectionStart:X,selectionEnd:P});return w&&!cf(ee,I)?pa(S,{...I,value:""}):pa(S,I),()=>{S.removeEventListener("input",F)}}},[d,w]),h.useEffect(()=>{function ee(){this.selectionEnd=this.selectionStart}if(z&&L.current){const F=L.current;return F.addEventListener("select",ee,!0),()=>F.removeEventListener("select",ee,!0)}},[z]),N.jsxs(N.Fragment,{children:[N.jsxs($S,{className:E,style:x,$dimension:a,ref:te,disabled:M.disabled,readOnly:M.readOnly,$isLoading:c,$status:s,"data-disabled":!!M.disabled||void 0,"data-read-only":!!M.readOnly||void 0,"data-loading":!!c||void 0,"data-status":s,$skeleton:$,"data-disable-copying":!!z||void 0,children:[N.jsx(xS,{ref:va(D,L),...M,onChange:ee=>{Oe(ee.currentTarget.value),M.onChange?.(ee)},placeholder:w,$dimension:a,$iconsAfterCount:K,$iconsBeforeCount:U,type:i==="password"&&lt?"text":i}),N.jsx(lr,{$status:s,disabled:M.disabled||M.readOnly}),U>0&&N.jsx(SS,{disabled:M.disabled,$dimension:a,children:J}),K>0&&N.jsx(ES,{disabled:M.disabled,$dimension:a,children:Z}),y]}),j&&ne&&ae&&N.jsx(dr,{renderContent:()=>L?.current?.value||"",targetElement:te.current})]})});wg.displayName="TextInput";const Tg=h.createContext(null),Mg=()=>h.useContext(Tg),NS=({children:a,...i})=>N.jsx(Tg.Provider,{value:i,children:a}),wS=h.createContext(null),Ag=()=>h.useContext(wS),sr=35,yp=4,kf=Y`
...
`,HS=Q.div`
  ...
  ${RS}
  ${kf}
  ${a=>a.$withCloseIcon?`padding-inline-start: ${(a.$dimension==="s"?8:12)-(a.$appearance==="outlined"?1:0)}px;`:OS}
...
`,VS=()=>"",qf=h.forwardRef(({dimension:a="m",disabled:i,appearance:u="outlined",selected:c,onClose:s,children:d,renderContentTooltip:g=VS,iconBefore:b,iconAfter:v,iconStart:m,iconEnd:y,badge:E,...x},w)=>{const $=c!==void 0,[j,z]=h.useState(!1),[M,D]=h.useState(!1),L=!!s,te=!!E,Z=h.useMemo(()=>c&&!i?"whiteBlue":i?c||u==="filled"?"whiteDisable":"lightDisable":u==="filled"?"white":"info",[u,c,i]),J=h.useRef(null),ae=h.useRef(null);return h.useEffect(()=>{ae.current&&mn(ae.current)!==j&&z(mn(ae.current))},[M,z]),h.useLayoutEffect(()=>{function se(){D(!0)}function ne(){D(!1)}const ge=J.current;if(ge)return ge.addEventListener("mouseenter",se),ge.addEventListener("mouseleave",ne),ge.addEventListener("focus",se),ge.addEventListener("blur",ne),()=>{ge.removeEventListener("mouseenter",se),ge.removeEventListener("mouseleave",ne),ge.removeEventListener("focus",se),ge.removeEventListener("blur",ne)}},[D]),N.jsxs(N.Fragment,{children:[N.jsx(HS,{...x,ref:va(w,J),$dimension:a,$disabled:i,$appearance:u,$selected:c,$defaultChip:$,$withCloseIcon:L,$withTooltip:j,$withBadge:te,onKeyDown:se=>{if(!i){const ne=G.getCode(se);ne!==G.Enter&&ne!==G[" "]||(L?s?.():x.onClick?.(se)),x.onKeyDown?.(se)}},tabIndex:x.tabIndex??(i?-1:0),$clickable:!!x.onClick,children:N.jsxs(jS,{$dimension:a,$disabled:i,$appearance:u,$selected:c,$withCloseIcon:L,children:[(m||b)&&N.jsx(US,{children:N.jsx(bp,{$dimension:a,$withCloseIcon:L,children:m||b})}),N.jsx(LS,{ref:ae,children:d}),E!==void 0&&N.jsx(qS,{"data-badge":!0,dimension:a,appearance:Z,children:E}),!s&&(y||v)&&N.jsx(kS,{$dimension:a,children:N.jsx(bp,{$dimension:a,$withCloseIcon:L,children:y||v})}),s&&N.jsx(YS,{dimension:a==="m"?"mBig":"s",highlightFocus:!1,onMouseDown:se=>{se.preventDefault(),s?.(x.id)},disabled:i,tabIndex:-1,appearance:u==="outlined"?"primary":"secondary"})]})}),M&&j&&N.jsx(dr,{targetElement:J.current,renderContent:g})]})});qf.displayName="Chips";const Og=Q.div`
  width: ${sr}px;
  height: 24px;
`,PS=Q.div`
  display: flex;
...
`,Ko=({value:a,disabled:i,renderChip:u,...c},s)=>{const d=u(),g={};return Ti(c,g,"data",!1),(b=>typeof b=="object"&&b!==null&&!h.isValidElement(b))(d)?{...d,onClose:()=>d.onClose?.({value:a,disabled:i,...g})}:{disabled:i,onClose:()=>s(a),children:d}},xp=({className:a,option:i,disabled:u,readOnly:c,onClick:s,onChipRemove:d})=>{const g=h.useCallback(b=>()=>N.jsx(XS,{children:b}),[]);return N.jsx(ZS,{className:a,tabIndex:-1,dimension:"s",appearance:"filled",onClick:s,onClose:c?void 0:Ko(i,d).onClose,disabled:Ko(i,d).disabled||u,renderContentTooltip:g(Ko(i,d).children),children:Ko(i,d).children})},FS=({count:a,disabled:i,onClick:u})=>{const c=h.useRef(null),s=h.useRef(null);return a?N.jsx(PS,{onClick:u,ref:c,className:"counter",children:N.jsxs(GS,{ref:s,"data-visible":!0,tabIndex:-1,dimension:"s",appearance:"filled",disabled:i,children:["+",a]})}):N.jsx(Og,{})},KS=Q.div`
  display: flex;
`,WS=h.forwardRef(({option:a,childrenOptions:i,containerRef:u,shouldShowCount:c,disabled:s,readOnly:d,onChipClick:g,onChipRemove:b},v)=>{const m=h.useRef(null),[y,E]=h.useState(!1);return h.useLayoutEffect(()=>{const x=new IntersectionObserver(function(w){if(w[0].isIntersecting&&!y){E(!0),w[0].target.setAttribute("data-visible","true");const $=w[0].target.previousElementSibling,j=w[0].target.nextElementSibling;return $&&$.removeAttribute("data-show-count"),void(j&&!j.getAttribute("data-visible")&&w[0].target.setAttribute("data-show-count",""))}if(y&&!w[0].isIntersecting){E(!1),w[0].target.removeAttribute("data-visible"),w[0].target.removeAttribute("data-show-count");const $=w[0].target.previousElementSibling;$&&$.getAttribute("data-visible")&&$.setAttribute("data-show-count","true")}},{root:u.current,threshold:[0,1]});return u.current&&m.current&&x.observe(m.current),()=>x.disconnect()},[y]),N.jsxs(KS,{ref:va(v,m),onMouseDown:x=>x.preventDefault(),children:[N.jsx(xp,{className:"chip",option:a,disabled:s,readOnly:d,onClick:g,onChipRemove:b}),c&&i.length>0&&N.jsx(FS,{count:i.length,disabled:s,children:i.map(x=>N.jsx(xp,{option:x,disabled:s,readOnly:d,onClick:g,onChipRemove:b},x.value))}),!c&&N.jsx(Og,{})]},a.value)}),JS=({options:a,isOptionsListOpen:i,containerRef:u,hasMaxHeight:c,...s})=>{const d=Rf(i);return h.useEffect(()=>{c&&a.length!==0&&(d&&!i&&u.current?.scrollTo({top:0,left:0,behavior:"smooth"}),!d&&i&&setTimeout(()=>{u.current?.scrollTo({top:0,left:0,behavior:"instant"}),u.current?.scrollTo({top:u.current?.scrollHeight,left:0,behavior:"smooth"})}),i&&d&&u.current?.scrollTo({top:u.current?.scrollHeight,left:0,behavior:"smooth"}))},[i,a,c]),N.jsx(N.Fragment,{children:a.map((g,b)=>N.jsx(WS,{option:g,childrenOptions:b<a.length-1?a.slice(b+1):[],containerRef:u,...s},g.value))})},cl=Q.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,u2=Q.div`
  ...
  ${({disabled:a,$readonly:i})=>i||a?r2:""};
  ${({$focused:a,$readonly:i,$isLoading:u})=>!a||i||u?"":i2};
...
`,h2=({visibleValue:a,isSearchPanelOpen:i,targetRef:u,forceHideOverflowTooltip:c})=>{const s=h.useRef(null),[d,g]=h.useState(!1),[b,v]=h.useState(!1);h.useEffect(()=>{s.current&&mn(s.current)!==d&&g(mn(s.current))},[b,g]),h.useEffect(()=>{function y(){v(!0)}function E(){v(!1)}const x=s.current;if(x)return x.addEventListener("mouseenter",y),x.addEventListener("mouseleave",E),()=>{x.removeEventListener("mouseenter",y),x.removeEventListener("mouseleave",E)}},[v]);const m=!c&&!i&&b&&d;return N.jsxs(N.Fragment,{children:[N.jsx(t2,{ref:s,children:a}),m&&N.jsx(dr,{renderContent:()=>a,targetElement:u.current})]})},m2=a=>a.stopPropagation(),p2=Q.select`
  ...
  border: none;
  pointer-events: none;
`,g2=h.forwardRef(({options:a,...i},u)=>{const c=h.useRef(null);return h.useEffect(()=>{function s(d){const g=G.getCode(d);g&&[G[" "],G.Enter,G.ArrowDown,G.ArrowUp].includes(g)&&d.preventDefault()}return c.current?.addEventListener("keydown",s),()=>c.current?.removeEventListener("keydown",s)},[]),N.jsxs(p2,{ref:va(u,c),...i,onClick:m2,children:[N.jsx("option",{value:""}),a.map(s=>N.jsx("option",{value:s.value,disabled:s.disabled,children:s.value},s.value))]})}),zg=h.createContext(null),v2=()=>h.useContext(zg),y2=({children:a,...i})=>N.jsx(zg.Provider,{value:i,children:a}),b2=(a="",i="",u="wholly")=>{const c=(u==="word"?i.split(" "):[i]).filter(Boolean).map(b=>b.toLowerCase()),s=["[","]","\\","^","$",".","|","?","*","+","(",")"],d=c.map(b=>`(${b.split("").map(v=>s.includes(v)?`\\${v}`:v).join("")})?`).join(""),g=a.split(new RegExp(d,"gi")).filter(Boolean);return!i||g.some(b=>c.includes(b.toLowerCase()))},x2=Q.label`
  display: inline-flex;
...
`,$2=Q(Sg)`
  margin-top: 2px;
`,Rg=h.forwardRef(({children:a,disabled:i=!1,readOnly:u=!1,hovered:c,dimension:s="m",error:d,indeterminate:g=!1,extraText:b,className:v,id:m,name:y,style:E,...x},w)=>{const $=h.useMemo(()=>m||Eg(),[m]),j={"data-field-id":$,"data-field-name":y};return wb(x,j),N.jsxs(x2,{className:v,$dimension:s,disabled:i,readOnly:u,style:E,...j,onClick:z=>{z.target.tagName!=="INPUT"&&z.stopPropagation()},children:[N.jsx($2,{...x,ref:w,disabled:i,readOnly:u,type:"checkbox",indeterminate:g,onKeyDown:z=>{u&&G.getCode(z)===G[" "]&&z.preventDefault(),x.onKeyDown?.(z)},"data-hovered":c,hovered:c,dimension:s,id:$,name:y,error:d}),a&&N.jsxs(S2,{$dimension:s,disabled:i,children:[a,b&&N.jsx(E2,{disabled:i,$dimension:s,children:b})]})]})});Rg.displayName="CheckboxField";Q(Bg)`
...
`;const _2=Q(Rg)`
  margin-right: 8px;
  flex-shrink: 0;
`,N2=a=>Mg()?N.jsx(w2,{...a}):null,w2=({disabled:a=!1,id:i,value:u,children:c,renderOption:s,renderChip:d,...g})=>{const b=Mg(),v=Ag(),m=v?.disabled||a,y=h.useCallback(()=>c,[c]),E=d||y,x=h.useMemo(()=>s?s({disabled:a}):c,[s,a,u,c]),w={};Ti(g,w,"data",!1);const $=h.useMemo(()=>({id:i,value:u,disabled:m,children:x,renderChip:E,...w}),[i,u,m,x,E]);return h.useEffect(()=>(b?.onConstantOptionMount?.($),()=>b?.onConstantOptionUnMount?.($)),[b?.onConstantOptionMount,b?.onConstantOptionUnMount,$]),null},T2=({id:a,disabled:i=!1,readOnly:u=!1,value:c,children:s,renderOption:d,renderChip:g,...b})=>{const v=v2(),m=Ag(),y=m?.disabled||i,E=x=>v?.multiple?(({selected:w=!1,hovered:$=!1})=>N.jsxs(N.Fragment,{children:[v?.showCheckbox&&N.jsx(_2,{checked:w,hovered:$,dimension:v?.dimension==="s"?"s":"m",disabled:i,onChange:()=>!1}),s]}))(x):s;return h.useEffect(()=>{const x=a||c,w={id:c,value:c,render:$=>{return d?d($):h.createElement(d2,{...$,dimension:(j=v?.dimension,j==="xl"?"l":j),key:x,...b,$selected:$.selected,$hovered:$.hovered,$preselected:$.preselected,$multiple:v?.multiple},E({selected:$.selected,hovered:$.hovered}));var j},disabled:y,readOnly:u};return v?.onDropDownOptionMount?.(w),()=>v?.onDropDownOptionUnMount?.(w)},[v?.onDropDownOptionMount,v?.onDropDownOptionUnMount,v?.dimension,v?.multiple]),null},Hg=a=>N.jsxs(N.Fragment,{children:[N.jsx(N2,{...a}),N.jsx(T2,{...a})]}),M2=Q(Bg)`
  color: var(--admiral-color-Neutral_Neutral50, ${a=>a.theme.color["Neutral/Neutral 50"]});
`,Sp=a=>a.stopPropagation(),Ep=()=>{},Yf=h.forwardRef(({value:a,isLoading:i,className:u,style:c,status:s,icons:d,portalTargetRef:g,targetElement:b,inputTargetRef:v,disabled:m,readOnly:y,placeholder:E,defaultValue:x,dimension:w="m",idleHeight:$="fixed",minRowCount:j="none",maxRowCount:z="none",mode:M="select",multiple:D=!1,showCheckbox:L=!0,displayClearIcon:te=!1,onClearIconClick:Z,onInputChange:J,inputValue:ae,defaultInputValue:se,renderSelectValue:ne,onFocus:ge,onBlur:qe,children:Oe,alignDropdown:Xe="stretch",alignSelf:lt="stretch",skeleton:Me=!1,locale:U,dropContainerCssMixin:K,dropContainerClassName:ee,dropContainerStyle:F,renderDropDownTopPanel:S,renderDropDownBottomPanel:B,renderTopPanel:X,renderBottomPanel:P,forcedOpen:I=!1,onChangeDropDownState:ue,onInputKeyDown:re,onInputKeyUp:Ve,onInputKeyUpCapture:ve,onInputKeyDownCapture:Je,searchFormat:Mt="wholly",onFilterItem:Pe=b2,virtualScroll:Be,title:zt,forceHideOverflowTooltip:Ma=!1,onSelectedChange:Va,moveSelectedOnTop:$t,clearInputValueAfterSelect:Qe=!0,openButtonPropsConfig:Lt=Ep,clearButtonPropsConfig:Rt=Ep,...mt},ea)=>{const kl=Af()||bu,vn=U?.emptyMessage||N.jsx(M2,{$dimension:w,children:kl.locales[kl.currentLocale].select.emptyMessage}),[Fe,ql]=h.useState(a??x),[Aa,yt]=h.useState(""),Ke=ae===void 0?Aa:ae,[ut,ie]=h.useState(!1),[pe,me]=h.useState(),[je,Ie]=h.useState([]),[ze,Vt]=h.useState([]),[we,Pt]=h.useState(I),[Gt,ta]=h.useState(!1),[aa,Ca]=h.useState(void 0),pr=a===void 0,la=M==="select",Di=h.useMemo(()=>z!=="none"&&z>0?z:$==="fixed"?1:"none",[z,$])!=="none",yn=a??x,Oa=h.useRef(Array.isArray(yn)?yn:[]),Yl=h.useRef(!1),ya=h.useRef([]);h.useEffect(()=>{Array.isArray(a)&&(Oa.current=a)},[a]);const Da=h.useMemo(()=>D?null:je.find(W=>W.value===Fe),[D,je,Fe]),et=h.useMemo(()=>D&&Array.isArray(Fe)?Fe.reduce((W,ce)=>{const ye=je.find(st=>st.value===ce);return ye&&W.push(ye),W},[]):[],[je,Fe,D]),At=Rf(we),[ba,bn]=h.useState([]);h.useEffect(()=>{if(D&&$t||!(ba.length>0)||bn([]),D&&$t&&At!==we&&we){const W=et.map(ye=>ye.value),ce=W.length>0?W.reduce((ye,st)=>{const pt=ze.find(oa=>oa.value===st);return pt&&ye.push(pt),ye},[]):[];bn(ce)}},[ze,we,et,D,$t]);const gr=h.useMemo(()=>{const W=ba.map(ye=>ye.value),ce=ze.filter(ye=>Pe(ye.value,Ke,Mt)).reduce((ye,st)=>(W.includes(st.value)||ye.push(st),ye),[...ba]);return ce.length?ce:[{id:"emptyMessage",render:()=>N.jsx(f2,{children:vn},"empty"),disabled:!0}]},[i,ze,w,Ke,ba]);h.useEffect(()=>{pe&&(gr.find(W=>W.id===pe)||me(void 0))},[gr,pe]);const na=v??h.useRef(null),Pa=h.useRef(null),Ct=h.useRef(null),vr=b||g?.current||Ct.current,Ga=h.useRef(null),ra=h.useRef(null),Xa=h.useRef({shouldExtendInputValue:!1}),dl=W=>{Ie(ce=>[...ce,W]),ya.current.includes(W.value)&&(ya.current=ya.current.filter(ce=>ce!==W.value))},ct=W=>{Oa.current.includes(W.value)&&(ya.current=[...ya.current,W.value]),Ie(ce=>ce.filter(ye=>ye.value!==W.value))},Bi=h.useCallback(W=>{Vt(ce=>[...ce,W])},[]),zi=h.useCallback(W=>{Vt(ce=>ce.filter(ye=>ye.id!==W.id))},[]),xa=h.useCallback(()=>{Pt(!1),na.current&&pa(na.current,{value:""}),ie(!0)},[Fe]),ia=h.useCallback(W=>{const ce=Pa.current;if(!ce)return;const ye=Array.from(ce.options),st=ye.find(pt=>pt.value===W);if(st&&(D||ye.forEach(pt=>pt.selected=!1),st.selected=!D||!st.selected,ce.dispatchEvent(new Event("change",{bubbles:!0})),D||xa(),Ke&&na.current&&Qe)){pa(na.current,{value:"",selectionEnd:0,selectionStart:0});const pt=pe;me(""),setTimeout(()=>me(pt))}},[xa,D,Ke,pe]),_u=h.useCallback(()=>{const W=Pa.current;W&&(W.selectedIndex=-1,W.dispatchEvent(new Event("change",{bubbles:!0})))},[]);h.useEffect(()=>{I!==we&&Pt(I)},[I]),h.useEffect(()=>{ue?.(we),!we&&Gt&&document.activeElement!==Ct.current&&Pa.current?.focus()},[we,Gt]);const Ri=Z||_u,yr=Di&&!we,Nu=h.useCallback(()=>N.jsx(JS,{containerRef:Ga,options:et,shouldShowCount:yr,disabled:m,readOnly:y,onChipRemove:ia,onChipClick:Sp,isOptionsListOpen:we,hasMaxHeight:!!z&&z!=="none"}),[et,yr,m,y,ia,we,z]),hl=(D?!Fe?.length:!Fe)&&!!E&&!Ke,xn=ne?.(Fe,Ke),Sa=Da?.children,br=D?Nu():Sa,ml=xn||br||Fe||null,Ea=typeof ml=="string",xr=Ea?N.jsx(h2,{visibleValue:ml,isSearchPanelOpen:we,targetRef:Ct,forceHideOverflowTooltip:Ma}):ml,Sn=()=>{Pt(W=>!W)},wu=()=>{if(!Ke&&Fe)return D?void(()=>{const W=(ce=[...et].reverse(),ce.find(({disabled:ye})=>!ye)?.value);var ce;W&&ia(W)})():ie(!1)};h.useEffect(()=>{if(!y&&!m)return Ct.current?.addEventListener("keydown",W),()=>{Ct.current?.removeEventListener("keydown",W)};function W(ce){const ye=G.getCode(ce);ye===G[" "]&&(!la&&Ke?ce.stopPropagation():we||(ce.preventDefault(),Pt(!0),ce.stopPropagation())),ye!==G.Enter||we||(ce.preventDefault(),Pt(!0),ce.stopPropagation()),ye!==G.ArrowDown&&ye!==G.ArrowUp||we||(Pt(!0),ce.stopPropagation());const st=ce.ctrlKey||ce.metaKey||ce.altKey;ce.key.length!==1||st||Ea&&!Ke&&ut&&(Xa.current.shouldExtendInputValue=!0),ye!==G.Backspace||ce.repeat||wu(),ye===G.Backspace&&((pt=>{if(!Ea||!na.current||Ke||!ut||!Fe)return;pt.preventDefault();const oa=ml.slice(0,-1);pa(na.current,{value:oa,selectionEnd:oa.length,selectionStart:oa.length})})(ce),Pt(!0)),ye===G.Escape&&we&&(Pt(!1),ce.preventDefault(),ce.stopPropagation())}},[y,m,la,Ke,we,et]),h.useEffect(()=>{function W(){Yl.current=!1}return Ct.current?.addEventListener("keyup",W),()=>{Ct.current?.removeEventListener("keyup",W)}},[]),h.useEffect(()=>{(!Gt&&!D||D)&&(na.current&&pa(na.current,{value:""}),ie(!0))},[D,Gt]),h.useEffect(()=>{we&&(la?Pa.current?.focus():na.current?.focus(),Ca(""))},[we,la]),h.useEffect(()=>{aa&&me("")},[aa]),h.useEffect(()=>{pe&&Ca("")},[pe]),h.useEffect(()=>{if(we){const W=Fe&&!Array.isArray(Fe)?Fe:void 0;me(W)}},[we]),h.useEffect(()=>{pr||ql(a)},[a,pr]),sg([Ct,ra],W=>{W.target&&Ct.current?.contains(W.target)||(ta(!1),xa())});const Hi=ut&&(D?!!Fe?.length:!!Fe),_t=h.useMemo(()=>h.Children.map(Oe,W=>h.isValidElement(W)?h.cloneElement(W,{key:Eg(),...W.props}):null),[Oe]),ji=h.useMemo(()=>N.jsx(y2,{onDropDownOptionMount:Bi,onDropDownOptionUnMount:zi,dimension:w,multiple:D,showCheckbox:L,children:_t}),[_t,w,L,D]),Tu=h.useMemo(()=>N.jsx(NS,{onConstantOptionMount:dl,onConstantOptionUnMount:ct,children:_t}),[_t]),En=Tb(mt),Li=ig(mt),Vl={icon:Su,id:"searchSelectClearIcon",onClick:Ri,"aria-hidden":!0},Ui={$isOpen:we,onClick:Sn,"aria-hidden":!0};return N.jsxs(u2,{className:u,style:c,$focused:Gt,$multiple:D,disabled:m,"data-disabled":m,$readonly:y,$isLoading:i,$dimension:w,ref:Ct,"data-status":s,onClick:m||y||i?void 0:W=>{W.target&&ra.current?.contains(W.target)||!la&&we||Sn()},onFocus:W=>{Gt||(ta(!0),ge?.(W))},onMouseDown:W=>{Gt&&W.preventDefault()},$skeleton:Me,onBlur:W=>{W.currentTarget.contains(W.relatedTarget)||ra.current?.contains(W.relatedTarget)||(ta(!1),Pt(!1),Pa.current?.blur(),qe?.(W),Yl.current=!1)},title:zt,children:[Tu,ji,N.jsx(g2,{ref:va(ea,Pa),value:Fe,multiple:D,disabled:m,options:je,...mt,onChange:W=>{if(Yl.current&&la)return void Ca(W.target.value);const ce=D?Array.from(W.target.selectedOptions).map(st=>st.value):W.target.value;let ye=[];if(D&&Array.isArray(ce)){const st=ce.filter($a=>!Oa.current.includes($a)&&!ya.current.includes($a)),pt=Oa.current.filter($a=>!ce.includes($a)&&!ya.current.includes($a));ye=[...Oa.current,...st];const oa=[...ya.current];pt.forEach($a=>{const Qa=ye.findIndex($n=>$a===$n);Qa>-1&&ye.splice(Qa,1);const ki=oa.findIndex($n=>$a===$n);ki>-1&&oa.splice(ki,1)}),Oa.current=ye,ya.current=oa}pr&&ql(D?ye:ce),mt.onChange?.(W),Va?.(D?ye:ce)}}),N.jsx(cl,{}),N.jsxs(Dg,{tabIndex:-1,ref:Ga,className:"selectValueWrapper",$dimension:w,$multiple:D,$minRowCount:j!=="none"?j:void 0,$maxRowCount:z!=="none"?z:void 0,$idleHeight:$,$opened:we,$isEmpty:hl,children:[ut&&xr,(E&&hl||!la)&&N.jsx(l2,{"data-id":mt.id,placeholder:hl?E:"",tabIndex:-1,ref:na,disabled:m,readOnly:y||la,value:Ke,defaultValue:se,$isMultiple:D,$dimension:w,onChange:W=>{D||ie(!1),(ce=>{Xa.current.shouldExtendInputValue&&Ea&&(ce.target.value=`${ml}${ce.target.value}`,Xa.current.shouldExtendInputValue=!1)})(W),ae===void 0&&yt(W.target.value),J?.(W)},onKeyDown:re,onKeyUp:Ve,onKeyUpCapture:ve,onKeyDownCapture:Je})]}),we&&!Me&&N.jsx(Of,{ref:ra,tabIndex:-1,targetElement:vr,"data-dimension":w,alignSelf:Xe||lt,dropContainerCssMixin:K,className:ee,style:F,...En,children:N.jsx(s2,{dimension:w==="xl"?"l":w,active:pe,selected:Fe,onActivateItem:W=>me(W),onSelectItem:ia,onDeselectItem:ia,multiSelection:D,model:gr,renderTopPanel:S||X,renderBottomPanel:B||P,containerRef:ra,virtualScroll:Be,preventFocusSteal:!0,preselectedModeActive:la,preselected:aa,onPreselectItem:Ca,onMenuKeyDown:()=>{Yl.current=!0},...Li})}),N.jsxs(o2,{$multiple:D,$dimension:w,onClick:Sp,onMouseDown:W=>W.preventDefault(),children:[i&&N.jsx(Uf,{dimension:w==="s"?"ms":"m"}),te&&!y&&Hi&&N.jsx(_i,{...Vl,...Rt(Vl)}),d,!y&&N.jsx(Mb,{"data-disabled":!!m||void 0,"data-loading":!!i||void 0,...Ui,...Lt(Ui)})]})]})});Yf.displayName="Select";var $p;function pf(){return pf=Object.assign?Object.assign.bind():function(a){for(var i=1;i<arguments.length;i++){var u=arguments[i];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},pf.apply(null,arguments)}var A2=function(a){return h.createElement("svg",pf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),$p||($p=h.createElement("path",{fill:"#74767B",fillRule:"evenodd",d:"M20.65 18c0 1.66-1.35 3-3 3h-8c-1.31 0-2.43-.84-2.84-2.01q-.36-.015-.69-.12a.65.65 0 0 1-.43-.81c.1-.35.46-.54.81-.44.05.02.1.03.15.04V8c0-1.66 1.34-3 3-3h7.16a1 1 0 0 0-.04-.15.64.64 0 0 1 .43-.81c.35-.11.71.09.81.43q.09.27.12.57A3 3 0 0 1 20.65 8zm-11 1.7h8c.93 0 1.7-.76 1.7-1.7V8c0-.94-.77-1.7-1.7-1.7h-8c-.94 0-1.71.76-1.71 1.7v10c0 .94.77 1.7 1.71 1.7m-4.28-3.2c.02.06.03.12.03.19a.647.647 0 0 1-1.27.18C4.04 16.6 4 16.3 4 16v-.95c0-.35.29-.65.65-.65.35 0 .65.3.65.65V16c0 .17.02.34.07.5m-.07-4.56c0 .36-.3.65-.65.65-.36 0-.65-.29-.65-.65v-1.89c0-.36.29-.65.65-.65.35 0 .65.29.65.65zm0-5c0 .36-.3.65-.65.65-.36 0-.65-.29-.65-.65v-.95c0-.36.05-.72.15-1.06.11-.34.47-.54.82-.43a.64.64 0 0 1 .43.81c-.07.21-.1.45-.1.68zm1.66-3.19c-.34.1-.71-.09-.81-.44a.6.6 0 0 1-.03-.19c0-.27.18-.53.46-.62.34-.1.7-.16 1.07-.16h.64c.36 0 .65.3.65.65 0 .36-.29.65-.65.65h-.64c-.24 0-.47.04-.69.11m9.06-1.27a.64.64 0 0 1 .43.81c-.1.34-.47.53-.81.43-.16-.05-.32-.08-.5-.08h-.77c-.36 0-.65-.29-.65-.65 0-.35.29-.65.65-.65h.77c.31 0 .6.05.88.14m-5.6 1.16c-.35 0-.65-.29-.65-.65 0-.35.3-.65.65-.65h1.42c.36 0 .65.3.65.65 0 .36-.29.65-.65.65z"})))};const gf=a=>{switch(a.$dimension){case"xl":default:return 24;case"s":return 20}},Vf=a=>{switch(a.$dimension){case"xl":return 16;case"m":default:return 8;case"s":return 6}},Pf=a=>{switch(a.$dimension){case"xl":case"m":default:return 16;case"s":return 12}},C2=Y`
...
`;function j2(a){return a}const L2=a=>a.preventDefault(),Us=(a,i)=>a*(i==="s"?20:24)+2*Vf({$dimension:i}),U2=Q(_g)`
...
`,k2=Hx(h.forwardRef((a,i)=>N.jsx("div",{ref:i,children:N.jsx(_i,{...a})})));function _p(a){return String(a||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/(\r?\n)$/g,"<br /><br />").replace(/\r?\n/g,"<br /> ")}const Np=()=>{},Lg=h.forwardRef(({rows:a=3,maxRows:i,value:u,displayClearIcon:c,displayCopyIcon:s,status:d,handleInput:g=j2,containerRef:b,icons:v,iconsAfter:m,children:y,className:E,autoHeight:x,skeleton:w=!1,dimension:$="m",disableCopying:j,locale:z,clearIconPropsConfig:M=Np,copyIconPropsConfig:D=Np,...L},te)=>{const Z=Af()||bu,J=h.useRef(null),[ae,se]=h.useState(null),ne=h.useRef(null),ge=h.Children.toArray(m||v),qe=z?.copyTextMessage||Z.locales[Z.currentLocale]?.textArea?.copyTextMessage,Oe=z?.copiedMessage||Z.locales[Z.currentLocale]?.textArea?.copiedMessage,[Xe,lt]=h.useState(qe),Me=S=>{S.preventDefault()},U={icon:Su,onMouseDown:Me,onClick:()=>{J.current&&pa(J.current,{value:""})},"aria-hidden":!0},K={tooltipDimension:"s",renderContent:()=>Xe,icon:A2,onMouseDown:Me,onClick:()=>{document.hasFocus()||window.focus(),J.current&&(navigator.clipboard.writeText(J.current.value),lt(Oe),setTimeout(()=>lt(qe),2e3))},"aria-hidden":!0};!L.readOnly&&J?.current?.value&&(c?ge.unshift(h.createElement(_i,{...U,...M(U),key:"clear-icon"})):s&&ge.unshift(h.createElement(k2,{...K,...D(K),key:"copy-icon"})));const ee=ge.length,F=u!=null?g({value:String(u)}):{};return h.useLayoutEffect(()=>{function S(){const{value:B,selectionStart:X,selectionEnd:P}=this,I=g({value:B,selectionStart:X,selectionEnd:P});pa(this,I)}if(J.current){const B=J.current;B.addEventListener("input",S);const{value:X,selectionStart:P,selectionEnd:I}=B,ue=g({value:X,selectionStart:P,selectionEnd:I});return pa(B,ue),()=>{B.removeEventListener("input",S)}}},[g]),h.useEffect(()=>{function S(){const{value:B}=this,X=ne.current;X&&(X.innerHTML=_p(B),this.style.overflowY=X.clientHeight<X.scrollHeight?"":"hidden")}if(x&&J.current&&ne.current){const B=J.current;return ne.current.innerHTML=_p(B.value),B.addEventListener("input",S),B.style.overflowY=ne.current.clientHeight<ne.current.scrollHeight?"":"hidden",()=>{B.removeEventListener("input",S),B.style.overflowY=""}}},[x,F.value,L.defaultValue]),N.jsxs(U2,{className:E,ref:b,"data-read-only":!!L.readOnly||void 0,"data-status":d,$skeleton:w,disabled:L.disabled,"data-disable-copying":!!j||void 0,$autoHeight:!!x,$rows:a,$maxRows:i,$dimension:$,...j&&{onMouseDown:L2},children:[N.jsx(z2,{ref:ne,$dimension:$,disabled:L.disabled,$iconsAfterCount:ee}),N.jsx(R2,{ref:va(te,J,S=>se(S)),...L,$dimension:$,$iconsAfterCount:ee,$autoHeight:x,value:F.value}),N.jsx(jt,{}),N.jsx(cg,{contentNode:ae}),ee>0&&N.jsx(H2,{disabled:L.disabled,$dimension:$,children:ge}),y]})});Lg.displayName="TextArea";const q2=Y`
...
`,G2=Q.button`
  ...
  border-radius: var(--admiral-border-radius-Small, ${a=>ur(a.theme.shape)});
  ${({$statusViaBackground:a,theme:i})=>a?Y2:`background: var(--admiral-color-Opacity_Neutral8, ${i.color["Opacity/Neutral 8"]});`}
  ${({$statusViaBackground:a})=>a?V2:"border: 1px solid transparent;"}
  ...
  &:active {
    ...
    ${({$statusViaBackground:a,theme:i,$clickable:u})=>u?a?P2:`background: var(--admiral-color-Opacity_Neutral12, ${i.color["Opacity/Neutral 12"]});`:""}
  }
...
`,nu=h.forwardRef(({children:a,kind:i="neutral",dimension:u="m",width:c,statusViaBackground:s=!1,isBorderHidden:d=!1,icon:g,statusIcon:b,onClick:v,...m},y)=>{const E=h.useRef(null),x=h.useRef(null),[w,$]=h.useState(!1),[j,z]=h.useState(!1),M=typeof i=="object"?i.background?i.background:"neutral":i,D=d?"transparent":typeof i=="object"?i.background&&i.border?i.border:"neutral":i,L=typeof i=="object"?i.backgroundHover?i.backgroundHover:i.background?i.background:"neutral":i;return h.useLayoutEffect(()=>{const te=x.current;te&&mn(te)!==w&&$(mn(te))},[j,$]),h.useLayoutEffect(()=>{function te(){z(!0)}function Z(){z(!1)}const J=E.current;if(J)return J.addEventListener("mouseenter",te),J.addEventListener("mouseleave",Z),J.addEventListener("focus",te),J.addEventListener("blur",Z),()=>{J.removeEventListener("mouseenter",te),J.removeEventListener("mouseleave",Z),J.removeEventListener("focus",te),J.removeEventListener("blur",Z)}},[z]),N.jsxs(N.Fragment,{children:[N.jsxs(G2,{ref:va(y,E),$width:c,onClick:v,$clickable:!!v,$statusViaBackground:s,$border:D,$background:M,$backgroundHover:L,$dimension:u,type:"button",...m,children:[M!=="neutral"&&!s&&N.jsx(Q2,{$background:M}),s&&g&&N.jsx(Z2,{children:g}),a&&N.jsx(X2,{ref:x,children:a}),b&&N.jsx(F2,{children:b})]}),j&&w&&N.jsx(dr,{targetElement:E.current,renderContent:()=>a})]})});nu.displayName="Tag";const K2=Q.div`
  display: flex;
  flex-flow: wrap;
  gap: 8px;
`,Ug=({children:a,width:i,dimension:u,kind:c,isBorderHidden:s,statusViaBackground:d,onClick:g,...b})=>N.jsx(K2,{...b,children:h.Children.map(a,v=>h.isValidElement(v)?h.cloneElement(v,{onClick:v.props.onClick||g,width:v.props.width||i,kind:v.props.kind||c,statusViaBackground:v.props.statusViaBackground||d,isBorderHidden:v.props.isBorderHidden||s,...v.props,dimension:u}):null)});Ug.displayName="Tags";const W2=Y`
  ${jf};
  pointer-events: none;
`,J2=Q.span`
  color: ${({$color:a,theme:i,$skeleton:u})=>{const c=`--admiral-color-${a?.replace("/","_").replaceAll(" ","")}`;return u?"transparent":a?i.color[a]?`var(${c}, ${i.color[a]})`:a:`var(--admiral-color-Neutral_Neutral90, ${i.color[_b]})`}};
  ${a=>a.theme.typography[a.$font]};
  ${a=>a.$cssMixin?a.$cssMixin:""}
  ${a=>a.$skeleton&&W2}
`,Ua=Df(({font:a,color:i,cssMixin:u,skeleton:c,...s},d)=>N.jsx(J2,{ref:d,...s,$font:a,$color:i,$cssMixin:u,$skeleton:c}));Ua.displayName="T";const I2="/task_manager_t1/assets/VTBGroupUI-SemiBold-Wupg3RVc.ttf",e6="/task_manager_t1/assets/VTBGroupUI-Medium-CJW7SkqK.otf",t6="/task_manager_t1/assets/VTBGroupUI-Regular-JWIonCWQ.otf",a6=`
    @font-face {
        font-family: 'VTB Group UI';
        src: url('${I2}') format('truetype');
        font-display: swap;
        font-weight: 550;
        font-style: normal;
...
`;function l6(a){return N.jsx("style",{type:"text/css",children:a6,...a})}var pi={},wp;function n6(){if(wp)return pi;wp=1,Object.defineProperty(pi,"__esModule",{value:!0}),pi.parse=g,pi.serialize=m;const a=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,i=/^[\u0021-\u003A\u003C-\u007E]*$/,u=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,c=/^[\u0020-\u003A\u003D-\u007E]*$/,s=Object.prototype.toString,d=(()=>{const x=function(){};return x.prototype=Object.create(null),x})();function g(x,w){const $=new d,j=x.length;if(j<2)return $;const z=w?.decode||y;let M=0;do{const D=x.indexOf("=",M);if(D===-1)break;const L=x.indexOf(";",M),te=L===-1?j:L;if(D>te){M=x.lastIndexOf(";",D-1)+1;continue}const Z=b(x,M,D),J=v(x,D,Z),ae=x.slice(Z,J);if($[ae]===void 0){let se=b(x,D+1,te),ne=v(x,te,se);const ge=z(x.slice(se,ne));$[ae]=ge}M=te+1}while(M<j);return $}function b(x,w,$){do{const j=x.charCodeAt(w);if(j!==32&&j!==9)return w}while(++w<$);return $}function v(x,w,$){for(;w>$;){const j=x.charCodeAt(--w);if(j!==32&&j!==9)return w+1}return $}function m(x,w,$){const j=$?.encode||encodeURIComponent;if(!a.test(x))throw new TypeError(`argument name is invalid: ${x}`);const z=j(w);if(!i.test(z))throw new TypeError(`argument val is invalid: ${w}`);let M=x+"="+z;if(!$)return M;if($.maxAge!==void 0){if(!Number.isInteger($.maxAge))throw new TypeError(`option maxAge is invalid: ${$.maxAge}`);M+="; Max-Age="+$.maxAge}if($.domain){if(!u.test($.domain))throw new TypeError(`option domain is invalid: ${$.domain}`);M+="; Domain="+$.domain}if($.path){if(!c.test($.path))throw new TypeError(`option path is invalid: ${$.path}`);M+="; Path="+$.path}if($.expires){if(!E($.expires)||!Number.isFinite($.expires.valueOf()))throw new TypeError(`option expires is invalid: ${$.expires}`);M+="; Expires="+$.expires.toUTCString()}if($.httpOnly&&(M+="; HttpOnly"),$.secure&&(M+="; Secure"),$.partitioned&&(M+="; Partitioned"),$.priority)switch(typeof $.priority=="string"?$.priority.toLowerCase():void 0){case"low":M+="; Priority=Low";break;case"medium":M+="; Priority=Medium";break;case"high":M+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${$.priority}`)}if($.sameSite)switch(typeof $.sameSite=="string"?$.sameSite.toLowerCase():$.sameSite){case!0:case"strict":M+="; SameSite=Strict";break;case"lax":M+="; SameSite=Lax";break;case"none":M+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${$.sameSite}`)}return M}function y(x){if(x.indexOf("%")===-1)return x;try{return decodeURIComponent(x)}catch{return x}}function E(x){return s.call(x)==="[object Date]"}return pi}n6();var Tp="popstate";function r6(a={}){function i(c,s){let{pathname:d,search:g,hash:b}=c.location;return vf("",{pathname:d,search:g,hash:b},s.state&&s.state.usr||null,s.state&&s.state.key||"default")}function u(c,s){return typeof s=="string"?s:wi(s)}return o6(i,u,null,a)}function at(a,i){if(a===!1||a===null||typeof a>"u")throw new Error(i)}function ka(a,i){if(!a){typeof console<"u"&&console.warn(i);try{throw new Error(i)}catch{}}}function i6(){return Math.random().toString(36).substring(2,10)}function Mp(a,i){return{usr:a.state,key:a.key,idx:i}}function vf(a,i,u=null,c){return{pathname:typeof a=="string"?a:a.pathname,search:"",hash:"",...typeof i=="string"?hr(i):i,state:u,key:i&&i.key||c||i6()}}function wi({pathname:a="/",search:i="",hash:u=""}){return i&&i!=="?"&&(a+=i.charAt(0)==="?"?i:"?"+i),u&&u!=="#"&&(a+=u.charAt(0)==="#"?u:"#"+u),a}function hr(a){let i={};if(a){let u=a.indexOf("#");u>=0&&(i.hash=a.substring(u),a=a.substring(0,u));let c=a.indexOf("?");c>=0&&(i.search=a.substring(c),a=a.substring(0,c)),a&&(i.pathname=a)}return i}function o6(a,i,u,c={}){let{window:s=document.defaultView,v5Compat:d=!1}=c,g=s.history,b="POP",v=null,m=y();m==null&&(m=0,g.replaceState({...g.state,idx:m},""));function y(){return(g.state||{idx:null}).idx}function E(){b="POP";let z=y(),M=z==null?null:z-m;m=z,v&&v({action:b,location:j.location,delta:M})}function x(z,M){b="PUSH";let D=vf(j.location,z,M);m=y()+1;let L=Mp(D,m),te=j.createHref(D);try{g.pushState(L,"",te)}catch(Z){if(Z instanceof DOMException&&Z.name==="DataCloneError")throw Z;s.location.assign(te)}d&&v&&v({action:b,location:j.location,delta:1})}function w(z,M){b="REPLACE";let D=vf(j.location,z,M);m=y();let L=Mp(D,m),te=j.createHref(D);g.replaceState(L,"",te),d&&v&&v({action:b,location:j.location,delta:0})}function $(z){return u6(z)}let j={get action(){return b},get location(){return a(s,g)},listen(z){if(v)throw new Error("A history only accepts one active listener");return s.addEventListener(Tp,E),v=z,()=>{s.removeEventListener(Tp,E),v=null}},createHref(z){return i(s,z)},createURL:$,encodeLocation(z){let M=$(z);return{pathname:M.pathname,search:M.search,hash:M.hash}},push:x,replace:w,go(z){return g.go(z)}};return j}function u6(a,i=!1){let u="http://localhost";typeof window<"u"&&(u=window.location.origin!=="null"?window.location.origin:window.location.href),at(u,"No window.location.(origin|href) available to create URL");let c=typeof a=="string"?a:wi(a);return c=c.replace(/ $/,"%20"),!i&&c.startsWith("//")&&(c=u+c),new URL(c,u)}function kg(a,i,u="/"){return c6(a,i,u,!1)}function c6(a,i,u,c){let s=typeof i=="string"?hr(i):i,d=fl(s.pathname||"/",u);if(d==null)return null;let g=qg(a);s6(g);let b=null;for(let v=0;b==null&&v<g.length;++v){let m=S6(d);b=b6(g[v],m,c)}return b}function qg(a,i=[],u=[],c=""){let s=(d,g,b)=>{let v={relativePath:b===void 0?d.path||"":b,caseSensitive:d.caseSensitive===!0,childrenIndex:g,route:d};v.relativePath.startsWith("/")&&(at(v.relativePath.startsWith(c),`Absolute route path "${v.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),v.relativePath=v.relativePath.slice(c.length));let m=sl([c,v.relativePath]),y=u.concat(v);d.children&&d.children.length>0&&(at(d.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${m}".`),qg(d.children,i,y,m)),!(d.path==null&&!d.index)&&i.push({path:m,score:v6(m,d.index),routesMeta:y})};return a.forEach((d,g)=>{if(d.path===""||!d.path?.includes("?"))s(d,g);else for(let b of Yg(d.path))s(d,g,b)}),i}function Yg(a){let i=a.split("/");if(i.length===0)return[];let[u,...c]=i,s=u.endsWith("?"),d=u.replace(/\?$/,"");if(c.length===0)return s?[d,""]:[d];let g=Yg(c.join("/")),b=[];return b.push(...g.map(v=>v===""?d:[d,v].join("/"))),s&&b.push(...g),b.map(v=>a.startsWith("/")&&v===""?"/":v)}function s6(a){a.sort((i,u)=>i.score!==u.score?u.score-i.score:y6(i.routesMeta.map(c=>c.childrenIndex),u.routesMeta.map(c=>c.childrenIndex)))}var f6=/^:[\w-]+$/,d6=3,h6=2,m6=1,p6=10,g6=-2,Ap=a=>a==="*";function v6(a,i){let u=a.split("/"),c=u.length;return u.some(Ap)&&(c+=g6),i&&(c+=h6),u.filter(s=>!Ap(s)).reduce((s,d)=>s+(f6.test(d)?d6:d===""?m6:p6),c)}function y6(a,i){return a.length===i.length&&a.slice(0,-1).every((c,s)=>c===i[s])?a[a.length-1]-i[i.length-1]:0}function b6(a,i,u=!1){let{routesMeta:c}=a,s={},d="/",g=[];for(let b=0;b<c.length;++b){let v=c[b],m=b===c.length-1,y=d==="/"?i:i.slice(d.length)||"/",E=du({path:v.relativePath,caseSensitive:v.caseSensitive,end:m},y),x=v.route;if(!E&&m&&u&&!c[c.length-1].route.index&&(E=du({path:v.relativePath,caseSensitive:v.caseSensitive,end:!1},y)),!E)return null;Object.assign(s,E.params),g.push({params:s,pathname:sl([d,E.pathname]),pathnameBase:N6(sl([d,E.pathnameBase])),route:x}),E.pathnameBase!=="/"&&(d=sl([d,E.pathnameBase]))}return g}function du(a,i){typeof a=="string"&&(a={path:a,caseSensitive:!1,end:!0});let[u,c]=x6(a.path,a.caseSensitive,a.end),s=i.match(u);if(!s)return null;let d=s[0],g=d.replace(/(.)\/+$/,"$1"),b=s.slice(1);return{params:c.reduce((m,{paramName:y,isOptional:E},x)=>{if(y==="*"){let $=b[x]||"";g=d.slice(0,d.length-$.length).replace(/(.)\/+$/,"$1")}const w=b[x];return E&&!w?m[y]=void 0:m[y]=(w||"").replace(/%2F/g,"/"),m},{}),pathname:d,pathnameBase:g,pattern:a}}function x6(a,i=!1,u=!0){ka(a==="*"||!a.endsWith("*")||a.endsWith("/*"),`Route path "${a}" will be treated as if it were "${a.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${a.replace(/\*$/,"/*")}".`);let c=[],s="^"+a.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(g,b,v)=>(c.push({paramName:b,isOptional:v!=null}),v?"/?([^\\/]+)?":"/([^\\/]+)"));return a.endsWith("*")?(c.push({paramName:"*"}),s+=a==="*"||a==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):u?s+="\\/*$":a!==""&&a!=="/"&&(s+="(?:(?=\\/|$))"),[new RegExp(s,i?void 0:"i"),c]}function S6(a){try{return a.split("/").map(i=>decodeURIComponent(i).replace(/\//g,"%2F")).join("/")}catch(i){return ka(!1,`The URL path "${a}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${i}).`),a}}function fl(a,i){if(i==="/")return a;if(!a.toLowerCase().startsWith(i.toLowerCase()))return null;let u=i.endsWith("/")?i.length-1:i.length,c=a.charAt(u);return c&&c!=="/"?null:a.slice(u)||"/"}function E6(a,i="/"){let{pathname:u,search:c="",hash:s=""}=typeof a=="string"?hr(a):a;return{pathname:u?u.startsWith("/")?u:$6(u,i):i,search:w6(c),hash:T6(s)}}function $6(a,i){let u=i.replace(/\/+$/,"").split("/");return a.split("/").forEach(s=>{s===".."?u.length>1&&u.pop():s!=="."&&u.push(s)}),u.length>1?u.join("/"):"/"}function ks(a,i,u,c){return`Cannot include a '${a}' character in a manually specified \`to.${i}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${u}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function _6(a){return a.filter((i,u)=>u===0||i.route.path&&i.route.path.length>0)}function Vg(a){let i=_6(a);return i.map((u,c)=>c===i.length-1?u.pathname:u.pathnameBase)}function Pg(a,i,u,c=!1){let s;typeof a=="string"?s=hr(a):(s={...a},at(!s.pathname||!s.pathname.includes("?"),ks("?","pathname","search",s)),at(!s.pathname||!s.pathname.includes("#"),ks("#","pathname","hash",s)),at(!s.search||!s.search.includes("#"),ks("#","search","hash",s)));let d=a===""||s.pathname==="",g=d?"/":s.pathname,b;if(g==null)b=u;else{let E=i.length-1;if(!c&&g.startsWith("..")){let x=g.split("/");for(;x[0]==="..";)x.shift(),E-=1;s.pathname=x.join("/")}b=E>=0?i[E]:"/"}let v=E6(s,b),m=g&&g!=="/"&&g.endsWith("/"),y=(d||g===".")&&u.endsWith("/");return!v.pathname.endsWith("/")&&(m||y)&&(v.pathname+="/"),v}var sl=a=>a.join("/").replace(/\/\/+/g,"/"),N6=a=>a.replace(/\/+$/,"").replace(/^\/*/,"/"),w6=a=>!a||a==="?"?"":a.startsWith("?")?a:"?"+a,T6=a=>!a||a==="#"?"":a.startsWith("#")?a:"#"+a;function M6(a){return a!=null&&typeof a.status=="number"&&typeof a.statusText=="string"&&typeof a.internal=="boolean"&&"data"in a}var Gg=["POST","PUT","PATCH","DELETE"];new Set(Gg);var A6=["GET",...Gg];new Set(A6);var mr=h.createContext(null);mr.displayName="DataRouter";var Eu=h.createContext(null);Eu.displayName="DataRouterState";var Xg=h.createContext({isTransitioning:!1});Xg.displayName="ViewTransition";var C6=h.createContext(new Map);C6.displayName="Fetchers";var O6=h.createContext(null);O6.displayName="Await";var qa=h.createContext(null);qa.displayName="Navigation";var Ai=h.createContext(null);Ai.displayName="Location";var Ya=h.createContext({outlet:null,matches:[],isDataRoute:!1});Ya.displayName="Route";var Gf=h.createContext(null);Gf.displayName="RouteError";function D6(a,{relative:i}={}){at(Ci(),"useHref() may be used only in the context of a <Router> component.");let{basename:u,navigator:c}=h.useContext(qa),{hash:s,pathname:d,search:g}=Oi(a,{relative:i}),b=d;return u!=="/"&&(b=d==="/"?u:sl([u,d])),c.createHref({pathname:b,search:g,hash:s})}function Ci(){return h.useContext(Ai)!=null}function gn(){return at(Ci(),"useLocation() may be used only in the context of a <Router> component."),h.useContext(Ai).location}var Qg="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Zg(a){h.useContext(qa).static||h.useLayoutEffect(a)}function Fg(){let{isDataRoute:a}=h.useContext(Ya);return a?X6():B6()}function B6(){at(Ci(),"useNavigate() may be used only in the context of a <Router> component.");let a=h.useContext(mr),{basename:i,navigator:u}=h.useContext(qa),{matches:c}=h.useContext(Ya),{pathname:s}=gn(),d=JSON.stringify(Vg(c)),g=h.useRef(!1);return Zg(()=>{g.current=!0}),h.useCallback((v,m={})=>{if(ka(g.current,Qg),!g.current)return;if(typeof v=="number"){u.go(v);return}let y=Pg(v,JSON.parse(d),s,m.relative==="path");a==null&&i!=="/"&&(y.pathname=y.pathname==="/"?i:sl([i,y.pathname])),(m.replace?u.replace:u.push)(y,m.state,m)},[i,u,d,s,a])}h.createContext(null);function z6(){let{matches:a}=h.useContext(Ya),i=a[a.length-1];return i?i.params:{}}function Oi(a,{relative:i}={}){let{matches:u}=h.useContext(Ya),{pathname:c}=gn(),s=JSON.stringify(Vg(u));return h.useMemo(()=>Pg(a,JSON.parse(s),c,i==="path"),[a,s,c,i])}function R6(a,i){return Kg(a,i)}function Kg(a,i,u,c){at(Ci(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:s}=h.useContext(qa),{matches:d}=h.useContext(Ya),g=d[d.length-1],b=g?g.params:{},v=g?g.pathname:"/",m=g?g.pathnameBase:"/",y=g&&g.route;{let M=y&&y.path||"";Wg(v,!y||M.endsWith("*")||M.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${v}" (under <Route path="${M}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${M}"> to <Route path="${M==="/"?"*":`${M}/*`}">.`)}let E=gn(),x;if(i){let M=typeof i=="string"?hr(i):i;at(m==="/"||M.pathname?.startsWith(m),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${m}" but pathname "${M.pathname}" was given in the \`location\` prop.`),x=M}else x=E;let w=x.pathname||"/",$=w;if(m!=="/"){let M=m.replace(/^\//,"").split("/");$="/"+w.replace(/^\//,"").split("/").slice(M.length).join("/")}let j=kg(a,{pathname:$});ka(y||j!=null,`No routes matched location "${x.pathname}${x.search}${x.hash}" `),ka(j==null||j[j.length-1].route.element!==void 0||j[j.length-1].route.Component!==void 0||j[j.length-1].route.lazy!==void 0,`Matched leaf route at location "${x.pathname}${x.search}${x.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let z=k6(j&&j.map(M=>Object.assign({},M,{params:Object.assign({},b,M.params),pathname:sl([m,s.encodeLocation?s.encodeLocation(M.pathname).pathname:M.pathname]),pathnameBase:M.pathnameBase==="/"?m:sl([m,s.encodeLocation?s.encodeLocation(M.pathnameBase).pathname:M.pathnameBase])})),d,u,c);return i&&z?h.createElement(Ai.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...x},navigationType:"POP"}},z):z}function H6(){let a=G6(),i=M6(a)?`${a.status} ${a.statusText}`:a instanceof Error?a.message:JSON.stringify(a),u=a instanceof Error?a.stack:null,c="rgba(200,200,200, 0.5)",s={padding:"0.5rem",backgroundColor:c},d={padding:"2px 4px",backgroundColor:c},g=null;return console.error("Error handled by React Router default ErrorBoundary:",a),g=h.createElement(h.Fragment,null,h.createElement("p",null,"💿 Hey developer 👋"),h.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",h.createElement("code",{style:d},"ErrorBoundary")," or"," ",h.createElement("code",{style:d},"errorElement")," prop on your route.")),h.createElement(h.Fragment,null,h.createElement("h2",null,"Unexpected Application Error!"),h.createElement("h3",{style:{fontStyle:"italic"}},i),u?h.createElement("pre",{style:s},u):null,g)}var j6=h.createElement(H6,null),L6=class extends h.Component{constructor(a){super(a),this.state={location:a.location,revalidation:a.revalidation,error:a.error}}static getDerivedStateFromError(a){return{error:a}}static getDerivedStateFromProps(a,i){return i.location!==a.location||i.revalidation!=="idle"&&a.revalidation==="idle"?{error:a.error,location:a.location,revalidation:a.revalidation}:{error:a.error!==void 0?a.error:i.error,location:i.location,revalidation:a.revalidation||i.revalidation}}componentDidCatch(a,i){console.error("React Router caught the following error during render",a,i)}render(){return this.state.error!==void 0?h.createElement(Ya.Provider,{value:this.props.routeContext},h.createElement(Gf.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function U6({routeContext:a,match:i,children:u}){let c=h.useContext(mr);return c&&c.static&&c.staticContext&&(i.route.errorElement||i.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=i.route.id),h.createElement(Ya.Provider,{value:a},u)}function k6(a,i=[],u=null,c=null){if(a==null){if(!u)return null;if(u.errors)a=u.matches;else if(i.length===0&&!u.initialized&&u.matches.length>0)a=u.matches;else return null}let s=a,d=u?.errors;if(d!=null){let v=s.findIndex(m=>m.route.id&&d?.[m.route.id]!==void 0);at(v>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(d).join(",")}`),s=s.slice(0,Math.min(s.length,v+1))}let g=!1,b=-1;if(u)for(let v=0;v<s.length;v++){let m=s[v];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(b=v),m.route.id){let{loaderData:y,errors:E}=u,x=m.route.loader&&!y.hasOwnProperty(m.route.id)&&(!E||E[m.route.id]===void 0);if(m.route.lazy||x){g=!0,b>=0?s=s.slice(0,b+1):s=[s[0]];break}}}return s.reduceRight((v,m,y)=>{let E,x=!1,w=null,$=null;u&&(E=d&&m.route.id?d[m.route.id]:void 0,w=m.route.errorElement||j6,g&&(b<0&&y===0?(Wg("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),x=!0,$=null):b===y&&(x=!0,$=m.route.hydrateFallbackElement||null)));let j=i.concat(s.slice(0,y+1)),z=()=>{let M;return E?M=w:x?M=$:m.route.Component?M=h.createElement(m.route.Component,null):m.route.element?M=m.route.element:M=v,h.createElement(U6,{match:m,routeContext:{outlet:v,matches:j,isDataRoute:u!=null},children:M})};return u&&(m.route.ErrorBoundary||m.route.errorElement||y===0)?h.createElement(L6,{location:u.location,revalidation:u.revalidation,component:w,error:E,children:z(),routeContext:{outlet:null,matches:j,isDataRoute:!0}}):z()},null)}function Xf(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function q6(a){let i=h.useContext(mr);return at(i,Xf(a)),i}function Y6(a){let i=h.useContext(Eu);return at(i,Xf(a)),i}function V6(a){let i=h.useContext(Ya);return at(i,Xf(a)),i}function Qf(a){let i=V6(a),u=i.matches[i.matches.length-1];return at(u.route.id,`${a} can only be used on routes that contain a unique "id"`),u.route.id}function P6(){return Qf("useRouteId")}function G6(){let a=h.useContext(Gf),i=Y6("useRouteError"),u=Qf("useRouteError");return a!==void 0?a:i.errors?.[u]}function X6(){let{router:a}=q6("useNavigate"),i=Qf("useNavigate"),u=h.useRef(!1);return Zg(()=>{u.current=!0}),h.useCallback(async(s,d={})=>{ka(u.current,Qg),u.current&&(typeof s=="number"?a.navigate(s):await a.navigate(s,{fromRouteId:i,...d}))},[a,i])}var Cp={};function Wg(a,i,u){!i&&!Cp[a]&&(Cp[a]=!0,ka(!1,u))}h.memo(Q6);function Q6({routes:a,future:i,state:u}){return Kg(a,void 0,u,i)}function yf(a){at(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Z6({basename:a="/",children:i=null,location:u,navigationType:c="POP",navigator:s,static:d=!1}){at(!Ci(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let g=a.replace(/^\/*/,"/"),b=h.useMemo(()=>({basename:g,navigator:s,static:d,future:{}}),[g,s,d]);typeof u=="string"&&(u=hr(u));let{pathname:v="/",search:m="",hash:y="",state:E=null,key:x="default"}=u,w=h.useMemo(()=>{let $=fl(v,g);return $==null?null:{location:{pathname:$,search:m,hash:y,state:E,key:x},navigationType:c}},[g,v,m,y,E,x,c]);return ka(w!=null,`<Router basename="${g}"> is not able to match the URL "${v}${m}${y}" because it does not start with the basename, so the <Router> won't render anything.`),w==null?null:h.createElement(qa.Provider,{value:b},h.createElement(Ai.Provider,{children:i,value:w}))}function F6({children:a,location:i}){return R6(bf(a),i)}function bf(a,i=[]){let u=[];return h.Children.forEach(a,(c,s)=>{if(!h.isValidElement(c))return;let d=[...i,s];if(c.type===h.Fragment){u.push.apply(u,bf(c.props.children,d));return}at(c.type===yf,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),at(!c.props.index||!c.props.children,"An index route cannot have child routes.");let g={id:c.props.id||d.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(g.children=bf(c.props.children,d)),u.push(g)}),u}var ru="get",iu="application/x-www-form-urlencoded";function $u(a){return a!=null&&typeof a.tagName=="string"}function K6(a){return $u(a)&&a.tagName.toLowerCase()==="button"}function W6(a){return $u(a)&&a.tagName.toLowerCase()==="form"}function J6(a){return $u(a)&&a.tagName.toLowerCase()==="input"}function I6(a){return!!(a.metaKey||a.altKey||a.ctrlKey||a.shiftKey)}function e3(a,i){return a.button===0&&(!i||i==="_self")&&!I6(a)}var Wo=null;function t3(){if(Wo===null)try{new FormData(document.createElement("form"),0),Wo=!1}catch{Wo=!0}return Wo}var a3=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function qs(a){return a!=null&&!a3.has(a)?(ka(!1,`"${a}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${iu}"`),null):a}function l3(a,i){let u,c,s,d,g;if(W6(a)){let b=a.getAttribute("action");c=b?fl(b,i):null,u=a.getAttribute("method")||ru,s=qs(a.getAttribute("enctype"))||iu,d=new FormData(a)}else if(K6(a)||J6(a)&&(a.type==="submit"||a.type==="image")){let b=a.form;if(b==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let v=a.getAttribute("formaction")||b.getAttribute("action");if(c=v?fl(v,i):null,u=a.getAttribute("formmethod")||b.getAttribute("method")||ru,s=qs(a.getAttribute("formenctype"))||qs(b.getAttribute("enctype"))||iu,d=new FormData(b,a),!t3()){let{name:m,type:y,value:E}=a;if(y==="image"){let x=m?`${m}.`:"";d.append(`${x}x`,"0"),d.append(`${x}y`,"0")}else m&&d.append(m,E)}}else{if($u(a))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');u=ru,c=null,s=iu,g=a}return d&&s==="text/plain"&&(g=d,d=void 0),{action:c,method:u.toLowerCase(),encType:s,formData:d,body:g}}function Zf(a,i){if(a===!1||a===null||typeof a>"u")throw new Error(i)}async function n3(a,i){if(a.id in i)return i[a.id];try{let u=await import(a.module);return i[a.id]=u,u}catch(u){return console.error(`Error loading route module \`${a.module}\`, reloading page...`),console.error(u),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function r3(a){return a==null?!1:a.href==null?a.rel==="preload"&&typeof a.imageSrcSet=="string"&&typeof a.imageSizes=="string":typeof a.rel=="string"&&typeof a.href=="string"}async function i3(a,i,u){let c=await Promise.all(a.map(async s=>{let d=i.routes[s.route.id];if(d){let g=await n3(d,u);return g.links?g.links():[]}return[]}));return s3(c.flat(1).filter(r3).filter(s=>s.rel==="stylesheet"||s.rel==="preload").map(s=>s.rel==="stylesheet"?{...s,rel:"prefetch",as:"style"}:{...s,rel:"prefetch"}))}function Op(a,i,u,c,s,d){let g=(v,m)=>u[m]?v.route.id!==u[m].route.id:!0,b=(v,m)=>u[m].pathname!==v.pathname||u[m].route.path?.endsWith("*")&&u[m].params["*"]!==v.params["*"];return d==="assets"?i.filter((v,m)=>g(v,m)||b(v,m)):d==="data"?i.filter((v,m)=>{let y=c.routes[v.route.id];if(!y||!y.hasLoader)return!1;if(g(v,m)||b(v,m))return!0;if(v.route.shouldRevalidate){let E=v.route.shouldRevalidate({currentUrl:new URL(s.pathname+s.search+s.hash,window.origin),currentParams:u[0]?.params||{},nextUrl:new URL(a,window.origin),nextParams:v.params,defaultShouldRevalidate:!0});if(typeof E=="boolean")return E}return!0}):[]}function o3(a,i,{includeHydrateFallback:u}={}){return u3(a.map(c=>{let s=i.routes[c.route.id];if(!s)return[];let d=[s.module];return s.clientActionModule&&(d=d.concat(s.clientActionModule)),s.clientLoaderModule&&(d=d.concat(s.clientLoaderModule)),u&&s.hydrateFallbackModule&&(d=d.concat(s.hydrateFallbackModule)),s.imports&&(d=d.concat(s.imports)),d}).flat(1))}function u3(a){return[...new Set(a)]}function c3(a){let i={},u=Object.keys(a).sort();for(let c of u)i[c]=a[c];return i}function s3(a,i){let u=new Set;return new Set(i),a.reduce((c,s)=>{let d=JSON.stringify(c3(s));return u.has(d)||(u.add(d),c.push({key:d,link:s})),c},[])}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var f3=new Set([100,101,204,205]);function d3(a,i){let u=typeof a=="string"?new URL(a,typeof window>"u"?"server://singlefetch/":window.location.origin):a;return u.pathname==="/"?u.pathname="_root.data":i&&fl(u.pathname,i)==="/"?u.pathname=`${i.replace(/\/$/,"")}/_root.data`:u.pathname=`${u.pathname.replace(/\/$/,"")}.data`,u}function Jg(){let a=h.useContext(mr);return Zf(a,"You must render this element inside a <DataRouterContext.Provider> element"),a}function h3(){let a=h.useContext(Eu);return Zf(a,"You must render this element inside a <DataRouterStateContext.Provider> element"),a}var Ff=h.createContext(void 0);Ff.displayName="FrameworkContext";function Ig(){let a=h.useContext(Ff);return Zf(a,"You must render this element inside a <HydratedRouter> element"),a}function m3(a,i){let u=h.useContext(Ff),[c,s]=h.useState(!1),[d,g]=h.useState(!1),{onFocus:b,onBlur:v,onMouseEnter:m,onMouseLeave:y,onTouchStart:E}=i,x=h.useRef(null);h.useEffect(()=>{if(a==="render"&&g(!0),a==="viewport"){let j=M=>{M.forEach(D=>{g(D.isIntersecting)})},z=new IntersectionObserver(j,{threshold:.5});return x.current&&z.observe(x.current),()=>{z.disconnect()}}},[a]),h.useEffect(()=>{if(c){let j=setTimeout(()=>{g(!0)},100);return()=>{clearTimeout(j)}}},[c]);let w=()=>{s(!0)},$=()=>{s(!1),g(!1)};return u?a!=="intent"?[d,x,{}]:[d,x,{onFocus:gi(b,w),onBlur:gi(v,$),onMouseEnter:gi(m,w),onMouseLeave:gi(y,$),onTouchStart:gi(E,w)}]:[!1,x,{}]}function gi(a,i){return u=>{a&&a(u),u.defaultPrevented||i(u)}}function p3({page:a,...i}){let{router:u}=Jg(),c=h.useMemo(()=>kg(u.routes,a,u.basename),[u.routes,a,u.basename]);return c?h.createElement(v3,{page:a,matches:c,...i}):null}function g3(a){let{manifest:i,routeModules:u}=Ig(),[c,s]=h.useState([]);return h.useEffect(()=>{let d=!1;return i3(a,i,u).then(g=>{d||s(g)}),()=>{d=!0}},[a,i,u]),c}function v3({page:a,matches:i,...u}){let c=gn(),{manifest:s,routeModules:d}=Ig(),{basename:g}=Jg(),{loaderData:b,matches:v}=h3(),m=h.useMemo(()=>Op(a,i,v,s,c,"data"),[a,i,v,s,c]),y=h.useMemo(()=>Op(a,i,v,s,c,"assets"),[a,i,v,s,c]),E=h.useMemo(()=>{if(a===c.pathname+c.search+c.hash)return[];let $=new Set,j=!1;if(i.forEach(M=>{let D=s.routes[M.route.id];!D||!D.hasLoader||(!m.some(L=>L.route.id===M.route.id)&&M.route.id in b&&d[M.route.id]?.shouldRevalidate||D.hasClientLoader?j=!0:$.add(M.route.id))}),$.size===0)return[];let z=d3(a,g);return j&&$.size>0&&z.searchParams.set("_routes",i.filter(M=>$.has(M.route.id)).map(M=>M.route.id).join(",")),[z.pathname+z.search]},[g,b,c,s,m,i,a,d]),x=h.useMemo(()=>o3(y,s),[y,s]),w=g3(y);return h.createElement(h.Fragment,null,E.map($=>h.createElement("link",{key:$,rel:"prefetch",as:"fetch",href:$,...u})),x.map($=>h.createElement("link",{key:$,rel:"modulepreload",href:$,...u})),w.map(({key:$,link:j})=>h.createElement("link",{key:$,...j})))}function y3(...a){return i=>{a.forEach(u=>{typeof u=="function"?u(i):u!=null&&(u.current=i)})}}var ev=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{ev&&(window.__reactRouterVersion="7.6.3")}catch{}function b3({basename:a,children:i,window:u}){let c=h.useRef();c.current==null&&(c.current=r6({window:u,v5Compat:!0}));let s=c.current,[d,g]=h.useState({action:s.action,location:s.location}),b=h.useCallback(v=>{h.startTransition(()=>g(v))},[g]);return h.useLayoutEffect(()=>s.listen(b),[s,b]),h.createElement(Z6,{basename:a,children:i,location:d.location,navigationType:d.action,navigator:s})}var tv=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Kf=h.forwardRef(function({onClick:i,discover:u="render",prefetch:c="none",relative:s,reloadDocument:d,replace:g,state:b,target:v,to:m,preventScrollReset:y,viewTransition:E,...x},w){let{basename:$}=h.useContext(qa),j=typeof m=="string"&&tv.test(m),z,M=!1;if(typeof m=="string"&&j&&(z=m,ev))try{let ne=new URL(window.location.href),ge=m.startsWith("//")?new URL(ne.protocol+m):new URL(m),qe=fl(ge.pathname,$);ge.origin===ne.origin&&qe!=null?m=qe+ge.search+ge.hash:M=!0}catch{ka(!1,`<Link to="${m}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let D=D6(m,{relative:s}),[L,te,Z]=m3(c,x),J=$3(m,{replace:g,state:b,target:v,preventScrollReset:y,relative:s,viewTransition:E});function ae(ne){i&&i(ne),ne.defaultPrevented||J(ne)}let se=h.createElement("a",{...x,...Z,href:z||D,onClick:M||d?i:ae,ref:y3(w,te),target:v,"data-discover":!j&&u==="render"?"true":void 0});return L&&!j?h.createElement(h.Fragment,null,se,h.createElement(p3,{page:D})):se});Kf.displayName="Link";var x3=h.forwardRef(function({"aria-current":i="page",caseSensitive:u=!1,className:c="",end:s=!1,style:d,to:g,viewTransition:b,children:v,...m},y){let E=Oi(g,{relative:m.relative}),x=gn(),w=h.useContext(Eu),{navigator:$,basename:j}=h.useContext(qa),z=w!=null&&M3(E)&&b===!0,M=$.encodeLocation?$.encodeLocation(E).pathname:E.pathname,D=x.pathname,L=w&&w.navigation&&w.navigation.location?w.navigation.location.pathname:null;u||(D=D.toLowerCase(),L=L?L.toLowerCase():null,M=M.toLowerCase()),L&&j&&(L=fl(L,j)||L);const te=M!=="/"&&M.endsWith("/")?M.length-1:M.length;let Z=D===M||!s&&D.startsWith(M)&&D.charAt(te)==="/",J=L!=null&&(L===M||!s&&L.startsWith(M)&&L.charAt(M.length)==="/"),ae={isActive:Z,isPending:J,isTransitioning:z},se=Z?i:void 0,ne;typeof c=="function"?ne=c(ae):ne=[c,Z?"active":null,J?"pending":null,z?"transitioning":null].filter(Boolean).join(" ");let ge=typeof d=="function"?d(ae):d;return h.createElement(Kf,{...m,"aria-current":se,className:ne,ref:y,style:ge,to:g,viewTransition:b},typeof v=="function"?v(ae):v)});x3.displayName="NavLink";var S3=h.forwardRef(({discover:a="render",fetcherKey:i,navigate:u,reloadDocument:c,replace:s,state:d,method:g=ru,action:b,onSubmit:v,relative:m,preventScrollReset:y,viewTransition:E,...x},w)=>{let $=w3(),j=T3(b,{relative:m}),z=g.toLowerCase()==="get"?"get":"post",M=typeof b=="string"&&tv.test(b),D=L=>{if(v&&v(L),L.defaultPrevented)return;L.preventDefault();let te=L.nativeEvent.submitter,Z=te?.getAttribute("formmethod")||g;$(te||L.currentTarget,{fetcherKey:i,method:Z,navigate:u,replace:s,state:d,relative:m,preventScrollReset:y,viewTransition:E})};return h.createElement("form",{ref:w,method:z,action:j,onSubmit:c?v:D,...x,"data-discover":!M&&a==="render"?"true":void 0})});S3.displayName="Form";function E3(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function av(a){let i=h.useContext(mr);return at(i,E3(a)),i}function $3(a,{target:i,replace:u,state:c,preventScrollReset:s,relative:d,viewTransition:g}={}){let b=Fg(),v=gn(),m=Oi(a,{relative:d});return h.useCallback(y=>{if(e3(y,i)){y.preventDefault();let E=u!==void 0?u:wi(v)===wi(m);b(a,{replace:E,state:c,preventScrollReset:s,relative:d,viewTransition:g})}},[v,b,m,u,c,i,a,s,d,g])}var _3=0,N3=()=>`__${String(++_3)}__`;function w3(){let{router:a}=av("useSubmit"),{basename:i}=h.useContext(qa),u=P6();return h.useCallback(async(c,s={})=>{let{action:d,method:g,encType:b,formData:v,body:m}=l3(c,i);if(s.navigate===!1){let y=s.fetcherKey||N3();await a.fetch(y,u,s.action||d,{preventScrollReset:s.preventScrollReset,formData:v,body:m,formMethod:s.method||g,formEncType:s.encType||b,flushSync:s.flushSync})}else await a.navigate(s.action||d,{preventScrollReset:s.preventScrollReset,formData:v,body:m,formMethod:s.method||g,formEncType:s.encType||b,replace:s.replace,state:s.state,fromRouteId:u,flushSync:s.flushSync,viewTransition:s.viewTransition})},[a,i,u])}function T3(a,{relative:i}={}){let{basename:u}=h.useContext(qa),c=h.useContext(Ya);at(c,"useFormAction must be used inside a RouteContext");let[s]=c.matches.slice(-1),d={...Oi(a||".",{relative:i})},g=gn();if(a==null){d.search=g.search;let b=new URLSearchParams(d.search),v=b.getAll("index");if(v.some(y=>y==="")){b.delete("index"),v.filter(E=>E).forEach(E=>b.append("index",E));let y=b.toString();d.search=y?`?${y}`:""}}return(!a||a===".")&&s.route.index&&(d.search=d.search?d.search.replace(/^\?/,"?index&"):"?index"),u!=="/"&&(d.pathname=d.pathname==="/"?u:sl([u,d.pathname])),wi(d)}function M3(a,i={}){let u=h.useContext(Xg);at(u!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=av("useViewTransitionState"),s=Oi(a,{relative:i.relative});if(!u.isTransitioning)return!1;let d=fl(u.currentLocation.pathname,c)||u.currentLocation.pathname,g=fl(u.nextLocation.pathname,c)||u.nextLocation.pathname;return du(s.pathname,g)!=null||du(s.pathname,d)!=null}[...f3];const A3=[{id:"1",title:"Разработка интерфейса",description:"Создать пользовательский интерфейс для главной страницы",category:"Feature",priority:"High",status:"In Progress"},{id:"2",title:"Тестирование API",description:"Провести тестирование всех конечных точек API",category:"Test",priority:"Medium",status:"To Do"},{id:"3",title:"Исправление ошибок",description:"Устранить баги в модуле авторизации",category:"Bug",priority:"High",status:"In Progress"},{id:"4",title:"Исправление ошибок",description:"Устранить баги в модуле авторизации",category:"Bug",priority:"High",status:"In Progress"},{id:"5",title:"Исправление ошибок",description:"Устранить баги в модуле авторизации",category:"Bug",priority:"Low",status:"In Progress"},{id:"6",title:"Исправление ошибок",description:"Устранить баги в модуле авторизации",category:"Bug",priority:"Medium",status:"In Progress"},{id:"7",title:"Исправление ошибок",description:"Устранить баги в модуле авторизации",category:"Bug",priority:"High",status:"In Progress"}],C3={tasks:A3},Wf=h.createContext(void 0),O3=({children:a})=>{const[i,u]=h.useState(()=>{const s=localStorage.getItem("tasks");return s?JSON.parse(s):C3.tasks}),c=(s,d)=>{u(g=>g.map(b=>b.id===s?{...b,...d}:b))};return h.useEffect(()=>{localStorage.setItem("tasks",JSON.stringify(i))},[i]),N.jsx(Wf.Provider,{value:{tasks:i,updateTask:c},children:a})},D3="_main_1ok86_1",B3={main:D3},z3="_filter_rve17_1",R3={filter:z3},lv=["Bug","Feature","Documentation","Refactor","Test"],xf=["All",...lv],nv=["Low","Medium","High"],Sf=["All",...nv],rv=["To Do","In Progress","Done"],Ef=["All",...rv],iv={category:"Категория",status:"Статус",priority:"Приоритет"},H3={category:xf,status:Ef,priority:Sf},j3={category:lv,status:rv,priority:nv};function Ys({type:a,setState:i}){const u=H3[a],[c,s]=h.useState(u[0]),d=g=>{s(g),i(g)};return N.jsxs("section",{children:[N.jsx("label",{htmlFor:a,children:N.jsxs(Ua,{font:"Additional/L",as:"p",children:[iv[a],":"]})}),N.jsx(Yf,{className:R3.filter,id:a,value:c,onChange:g=>d(g.target.value),children:u.map(g=>N.jsx(Hg,{value:g,children:g},g))})]})}function L3({setFilterCategory:a,setFilterStatus:i,setFilterPriority:u}){return N.jsxs("section",{className:B3.main,children:[N.jsx(Ys,{type:"category",setState:a}),N.jsx(Ys,{type:"status",setState:i}),N.jsx(Ys,{type:"priority",setState:u})]})}const U3="_card_1ciuv_1",k3="_textBlock_1ciuv_25",q3="_title_1ciuv_33",Y3="_description_1ciuv_51",Jo={card:U3,textBlock:k3,title:q3,description:Y3},Vs=a=>({"To Do":"warning","In Progress":"primary",Done:"success",Low:"neutral",Medium:"warning",High:"danger",Bug:"danger",Feature:"primary",Documentation:"warning",Refactor:"primary",Test:"warning"})[a]??"neutral";function V3(a){return N.jsxs("li",{className:Jo.card,children:[N.jsxs("div",{className:Jo.textBlock,children:[N.jsx(Ua,{font:"Main/M",as:"h2",className:Jo.title,children:a.title}),N.jsx(Ua,{font:"Main/S",as:"h3",className:Jo.description,children:a.description})]}),N.jsxs(Ug,{children:[N.jsx(nu,{as:"span",statusViaBackground:!0,kind:Vs(a.category),children:a.category}),N.jsx(nu,{as:"span",statusViaBackground:!0,kind:Vs(a.status),children:a.status}),N.jsx(nu,{as:"span",statusViaBackground:!0,kind:Vs(a.priority),children:a.priority})]}),N.jsx(Kf,{to:`/task/${a.id}`,children:N.jsx(fu,{dimension:"s",appearance:"tertiary",children:"Редактировать"})})]})}const P3="_list_eumqh_1",G3="_noTasks_eumqh_17",Dp={list:P3,noTasks:G3};function X3({tasks:a}){return a.length==0?N.jsx(Ua,{as:"div",font:"Additional/L",className:Dp.noTasks,children:"Задачи не найдены"}):N.jsx("ul",{className:Dp.list,children:a.map(i=>N.jsx(V3,{...i},i.id))})}const Q3="_wrapper_1le7r_1",Z3={wrapper:Q3};function F3(){const a=h.useContext(Wf),[i,u]=h.useState(xf[0]),[c,s]=h.useState(Ef[0]),[d,g]=h.useState(Sf[0]);if(!a)return null;const{tasks:b}=a,v=b.filter(m=>(i===xf[0]||m.category===i)&&(c===Ef[0]||m.status===c)&&(d===Sf[0]||m.priority===d));return N.jsxs("div",{className:Z3.wrapper,children:[N.jsx(L3,{setFilterCategory:u,setFilterStatus:s,setFilterPriority:g}),N.jsx(X3,{tasks:v})]})}const K3="_form_11yzn_1",W3="_textInput_11yzn_17",J3="_textArea_11yzn_25",I3="_btns_11yzn_37",eE="_isVisible_11yzn_47",tE="_isNotVisible_11yzn_55",aE="_errorPage_11yzn_73",on={form:K3,textInput:W3,textArea:J3,btns:I3,isVisible:eE,isNotVisible:tE,errorPage:aE},lE="_selectWrapper_z8emq_1",nE="_filter_z8emq_13",Ps={selectWrapper:lE,filter:nE};function Gs({type:a,value:i,changeTask:u}){const c=j3[a],[s,d]=h.useState(i),g=b=>{u(a,b),d(b)};return N.jsxs("section",{className:Ps.selectWrapper,children:[N.jsx("label",{htmlFor:a,className:Ps.labelForType,children:N.jsxs(Ua,{font:"Main/S",as:"p",children:[iv[a],":"]})}),N.jsx(Yf,{className:Ps.filter,id:a,value:s,onChange:b=>g(b.target.value),children:c.map(b=>N.jsx(Hg,{value:b,children:b},b))})]})}function rE(){const{id:a}=z6(),i=Fg(),{tasks:u,updateTask:c}=h.useContext(Wf),s=u.find(x=>x.id===a),[d,g]=h.useState(s),[b,v]=h.useState(!0),m=(x,w)=>{g($=>({...$,[x]:w}))};if(!s||!a)return N.jsx("div",{className:on.errorPage,children:N.jsx(Ua,{as:"p",font:"Body/Body 1 Long",children:"Такой задачи не существует..."})});const y=()=>{d.title?(c(a,d),E()):v(!1)},E=()=>{i("/")};return N.jsxs("form",{className:on.form,children:[N.jsx("div",{children:N.jsxs("label",{children:[N.jsx(Ua,{font:"Main/S",children:"Заголовок:"}),N.jsx(wg,{className:on.textInput,required:!0,defaultValue:s.title,onChange:x=>m("title",x.target.value),dimension:"s"}),N.jsx(Ua,{font:"Additional/S",color:"Error/Error 60 Main",className:b?on.isNotVisible:on.isVisible,children:"Заголовок обязателен для заполнения"})]})}),N.jsx("div",{children:N.jsxs("label",{children:[N.jsx(Ua,{font:"Main/S",children:"Описание:"}),N.jsx(Lg,{className:on.textArea,defaultValue:s.description,onChange:x=>m("description",x.target.value),dimension:"s"})]})}),N.jsx(Gs,{type:"category",value:s.category,changeTask:m}),N.jsx(Gs,{type:"status",value:s.status,changeTask:m}),N.jsx(Gs,{type:"priority",value:s.priority,changeTask:m}),N.jsxs("div",{className:on.btns,children:[N.jsx(fu,{appearance:"success",dimension:"s",onClick:y,children:"Сохранить"}),N.jsx(fu,{appearance:"tertiary",dimension:"s",onClick:E,children:"Отмена"})]})]})}function iE(){return N.jsx(O3,{children:N.jsx(b3,{children:N.jsxs(F6,{children:[N.jsx(yf,{path:"/",element:N.jsx(F3,{})}),N.jsx(yf,{path:"/task/:id",element:N.jsx(rE,{})})]})})})}y1.createRoot(document.getElementById("root")).render(N.jsx(h.StrictMode,{children:N.jsx(vb,{theme:bu,children:N.jsxs(Bb,{children:[N.jsx(l6,{}),N.jsx(iE,{})]})})}));
